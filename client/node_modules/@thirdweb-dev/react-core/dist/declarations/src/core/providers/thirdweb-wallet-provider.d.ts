...
type ConnectFnArgs<I extends WalletInstance, Config extends Record<string, any> | undefined> = undefined extends WalletConnectParams<I> ? [
...
type ThirdwebWalletContextData = {
    ...
    connect: <I extends WalletInstance, Config extends Record<string, any> | undefined = undefined>(...args: ConnectFnArgs<I, Config>) => Promise<I>;
    disconnect: () => Promise<void>;
    connectionStatus: ConnectionStatus;
    setConnectionStatus: (status: ConnectionStatus) => void;
    createWalletInstance: <I extends WalletInstance, Config extends Record<string, any> | undefined>(Wallet: WalletConfig<I, Config>) => I;
