...
class Edition extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", contractMetadata.buildTransactionFunction(async metadataWithSupply => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", contractMetadata.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintAdditionalSupply", contractMetadata.buildTransactionFunction(async (tokenId, additionalSupply) => {
     ...
     * @param additionalSupply - the additional amount to mint
     */
    QueryParams._defineProperty(this, "mintAdditionalSupplyTo", contractMetadata.buildTransactionFunction(async (to, tokenId, additionalSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintBatch", contractMetadata.buildTransactionFunction(async metadatas => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", contractMetadata.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", contractMetadata.buildTransactionFunction(async (tokenId, amount) => {
      return this.erc1155.burn.prepare(tokenId, amount);
    }));
    this.abi = contractMetadata.AbiSchema.parse(abi || []);
    this.metadata = new contractMetadata.ContractMetadata(this.contractWrapper, contractMetadata.TokenErc1155ContractSchema, this.storage);
    this.app = new contractMetadata.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new contractMetadata.ContractRoles(this.contractWrapper, Edition.contractRoles);
    ...
    this.signature = new contractMetadata.Erc1155SignatureMintable(this.contractWrapper, this.storage, this.roles);
