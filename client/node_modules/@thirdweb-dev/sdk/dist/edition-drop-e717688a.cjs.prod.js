...
class EditionDrop extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, _address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new contractMetadata.ContractWrapper(network, _address, abi, _options);
     ...
     */
    QueryParams._defineProperty(this, "claimTo", contractMetadata.buildTransactionFunction(async function (destinationAddress, tokenId, quantity) {
     ...
     * @returns - Receipt for the transaction
     */
    QueryParams._defineProperty(this, "claim", contractMetadata.buildTransactionFunction(async function (tokenId, quantity) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", contractMetadata.buildTransactionFunction(async (tokenId, amount) => {
      return this.erc1155.burn.prepare(tokenId, amount);
    }));
    this.abi = contractMetadata.AbiSchema.parse(abi);
    this.metadata = new contractMetadata.ContractMetadata(this.contractWrapper, contractMetadata.DropErc1155ContractSchema, this.storage);
    this.app = new contractMetadata.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new contractMetadata.ContractRoles(this.contractWrapper, EditionDrop.contractRoles);
    ...
    this.claimConditions = new contractMetadata.DropErc1155ClaimConditions(this.contractWrapper, this.metadata, this.storage);
