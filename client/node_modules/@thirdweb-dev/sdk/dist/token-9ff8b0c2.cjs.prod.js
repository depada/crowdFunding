...
var erc20History = require('./erc-20-history-275d86c8.cjs.prod.js');
...
class Token extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", contractMetadata.buildTransactionFunction(async amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", contractMetadata.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", contractMetadata.buildTransactionFunction(async args => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", contractMetadata.buildTransactionFunction(amount => {
    ...
    this.metadata = new contractMetadata.ContractMetadata(this.contractWrapper, contractMetadata.TokenErc20ContractSchema, this.storage);
    this.app = new contractMetadata.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new contractMetadata.ContractRoles(this.contractWrapper, Token.contractRoles);
    ...
    this.signature = new contractMetadata.Erc20SignatureMintable(this.contractWrapper, this.roles);
  }
