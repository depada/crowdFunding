...
var erc20Standard = require('./erc-20-standard-42385bb8.cjs.prod.js');
...
class TokenDrop extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claim", contractMetadata.buildTransactionFunction(async function (amount) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", contractMetadata.buildTransactionFunction(async function (destinationAddress, amount) {
     ...
     * @alpha
     */
    QueryParams._defineProperty(this, "delegateTo", contractMetadata.buildTransactionFunction(async delegateeAddress => {
      return contractMetadata.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "delegate",
        args: [await contractMetadata.resolveAddress(delegateeAddress)]
      });
    }));
    /**
     * Burn Tokens
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", contractMetadata.buildTransactionFunction(async amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnFrom", contractMetadata.buildTransactionFunction(async (holder, amount) => {
      return this.erc20.burnFrom.prepare(holder, amount);
    }));
    this.abi = contractMetadata.AbiSchema.parse(abi || []);
    this.metadata = new contractMetadata.ContractMetadata(this.contractWrapper, contractMetadata.DropErc20ContractSchema, this.storage);
    this.app = new contractMetadata.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new contractMetadata.ContractRoles(this.contractWrapper, TokenDrop.contractRoles);
  ...
  async getVoteBalanceOf(account) {
    return await this.erc20.getValue(await this.contractWrapper.readContract.getVotes(await contractMetadata.resolveAddress(account)));
  }
  ...
  async getDelegationOf(account) {
    return await this.contractWrapper.readContract.delegates(await contractMetadata.resolveAddress(account));
  }
