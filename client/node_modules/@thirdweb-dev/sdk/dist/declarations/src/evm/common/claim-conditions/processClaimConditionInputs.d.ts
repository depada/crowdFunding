...
import { ClaimConditionInput } from "../../types";
 ...
 */
export declare function processSnapshotData(claimConditionInputs: ClaimConditionInput[], tokenDecimals: number, provider: ethers.providers.Provider, storage: ThirdwebStorage, snapshotFormatVersion: SnapshotFormatVersion): Promise<{
    inputsWithSnapshots: {
