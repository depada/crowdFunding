...
export declare class PackVRF implements UpdateableNetwork, DetectableFeature {
     ...
     */
    open: {
        (tokenId: BigNumberish, amount?: BigNumberish | undefined, gasLimit?: any): Promise<TransactionResultWithId<never>>;
        prepare: (tokenId: BigNumberish, amount?: BigNumberish | undefined, gasLimit?: any) => Promise<Transaction<TransactionResultWithId<never>>>;
    };
    /**
