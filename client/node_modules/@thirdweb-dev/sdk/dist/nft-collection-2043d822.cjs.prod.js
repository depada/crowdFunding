...
class NFTCollection extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mint", contractMetadata.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", contractMetadata.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatch", contractMetadata.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", contractMetadata.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", contractMetadata.buildTransactionFunction(tokenId => {
      return this.erc721.burn.prepare(tokenId);
    }));
    this.abi = contractMetadata.AbiSchema.parse(abi || []);
    this.metadata = new contractMetadata.ContractMetadata(this.contractWrapper, contractMetadata.TokenErc721ContractSchema, this.storage);
    this.app = new contractMetadata.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new contractMetadata.ContractRoles(this.contractWrapper, NFTCollection.contractRoles);
