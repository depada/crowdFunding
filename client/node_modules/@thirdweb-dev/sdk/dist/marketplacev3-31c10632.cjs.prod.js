...
class MarketplaceV3 {
   ...
   */
  get directListings() {
    return contractMetadata.assertEnabled(this.detectDirectListings(), contractMetadata.FEATURE_DIRECT_LISTINGS);
  }
  /**
   * Auctions
   ...
   */
  get englishAuctions() {
    return contractMetadata.assertEnabled(this.detectEnglishAuctions(), contractMetadata.FEATURE_ENGLISH_AUCTIONS);
  }
   ...
   */
  get offers() {
    return contractMetadata.assertEnabled(this.detectOffers(), contractMetadata.FEATURE_OFFERS);
  }
  get chainId() {
  ...
  constructor(network, address, storage) {
    ...
    this.roles = new contractMetadata.ContractRoles(this.contractWrapper, MarketplaceV3.contractRoles);
  ...
  detectDirectListings() {
    if (contractMetadata.detectContractFeature(this.contractWrapper, "DirectListings")) {
      return new contractMetadata.MarketplaceV3DirectListings(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectEnglishAuctions() {
    if (contractMetadata.detectContractFeature(this.contractWrapper, "EnglishAuctions")) {
      return new contractMetadata.MarketplaceV3EnglishAuctions(this.contractWrapper, this.storage);
    }
    return undefined;
  }
  detectOffers() {
    if (contractMetadata.detectContractFeature(this.contractWrapper, "Offers")) {
      return new contractMetadata.MarketplaceV3Offers(this.contractWrapper, this.storage);
    }
    return undefined;
  }
}
