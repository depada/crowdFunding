...
class StandardErc1155 {
  ...
  constructor(contractWrapper, storage, chainId) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", contractMetadata.buildTransactionFunction(async function (to, tokenId, amount) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "airdrop", contractMetadata.buildTransactionFunction(async function (tokenId, addresses) {
    ...
    this.erc1155 = new contractMetadata.Erc1155(this.contractWrapper, this.storage, chainId);
