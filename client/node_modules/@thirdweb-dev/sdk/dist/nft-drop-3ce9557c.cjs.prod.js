...
var erc721Standard = require('./erc-721-standard-6401fd8b.cjs.prod.js');
var thirdwebCheckout = require('./thirdweb-checkout-e747c1e7.cjs.prod.js');
...
class NFTDrop extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new contractMetadata.ContractWrapper(network, address, abi, _options);
     ...
     */
    QueryParams._defineProperty(this, "createBatch", contractMetadata.buildTransactionFunction(async (metadatas, options) => {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", contractMetadata.buildTransactionFunction(async function (destinationAddress, quantity) {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    QueryParams._defineProperty(this, "claim", contractMetadata.buildTransactionFunction(async function (quantity) {
     ...
     *
     */
    QueryParams._defineProperty(this, "burn", contractMetadata.buildTransactionFunction(async tokenId => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", contractMetadata.buildTransactionFunction(async (to, tokenId) => {
     ...
     * @internal
     */
    QueryParams._defineProperty(this, "setApprovalForAll", contractMetadata.buildTransactionFunction(async (operator, approved) => {
     ...
     * @internal
     */
    QueryParams._defineProperty(this, "setApprovalForToken", contractMetadata.buildTransactionFunction(async (operator, tokenId) => {
    ...
    this.metadata = new contractMetadata.ContractMetadata(this.contractWrapper, contractMetadata.DropErc721ContractSchema, this.storage);
    this.app = new contractMetadata.ContractAppURI(this.contractWrapper, this.metadata, this.storage);
    this.roles = new contractMetadata.ContractRoles(this.contractWrapper, NFTDrop.contractRoles);
    this.royalties = new contractMetadata.ContractRoyalty(this.contractWrapper, this.metadata);
    this.sales = new contractMetadata.ContractPrimarySale(this.contractWrapper);
    this.claimConditions = new contractMetadata.DropClaimConditions(this.contractWrapper, this.metadata, this.storage);
    ...
    this.revealer = new contractMetadata.DelayedReveal(this.contractWrapper, this.storage, contractMetadata.FEATURE_NFT_REVEALABLE.name, () => this.erc721.nextTokenIdToMint());
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole(contractMetadata.getRoleHash("transfer"), ethers.constants.AddressZero);
