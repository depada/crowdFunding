...
class StandardErc20 {
  ...
  constructor(contractWrapper, storage, chainId) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", contractMetadata.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferFrom", contractMetadata.buildTransactionFunction(async (from, to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "setAllowance", contractMetadata.buildTransactionFunction(async (spender, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferBatch", contractMetadata.buildTransactionFunction(async args => {
      return this.erc20.transferBatch.prepare(args);
    }));
    this.contractWrapper = contractWrapper;
    this.storage = storage;
    this.erc20 = new contractMetadata.Erc20(this.contractWrapper, this.storage, chainId);
