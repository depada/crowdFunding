...
import { ct as fetchAndCacheDeployMetadata, bF as extractFunctionParamsFromAbi, cq as convertParamValues, bE as extractConstructorParamsFromAbi, aT as ThirdwebSDK } from '../../../dist/contract-metadata-fe1c84c2.browser.esm.js';
...
async function zkDeployContractFromUri(publishMetadataUri, constructorParamValues, signer, storage, chainId, options) {
  ...
  if (extendedMetadata && extendedMetadata.factoryDeploymentData && (extendedMetadata.isDeployableViaProxy || extendedMetadata.isDeployableViaFactory) && !forceDirectDeploy) {
    ...
    const proxyFactory = new zk.ContractFactory(twProxyArtifactZK.abi, twProxyArtifactZK.bytecode, signer, "create");
    ...
    const factory = new zk.ContractFactory(compilerMetadata.abi, compilerMetadata.bytecode, signer, "create");
...
export { getZkTransactionsForDeploy, zkDeployContractFromUri };
