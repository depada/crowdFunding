import {
  safeWallet
} from "./chunk-X227Q3NL.js";
import {
  magicLink
} from "./chunk-JKCZ3QI3.js";
import {
  ...
  walletConnectV1
} from "./chunk-WVQAX277.js";
import {
  paperWallet
} from "./chunk-7KKI4J2Q.js";
import {
  TextDivider
} from "./chunk-PUMZVR7R.js";
import {
  Button,
  CheckIcon,
  ChevronRightIcon,
  ...
  useWinningBid
} from "./chunk-GELTR3I4.js";
import {
  walletConnect
} from "./chunk-JJJPZTN5.js";
import {
  LocalWallet,
  SmartWallet
} from "./chunk-BJ2JJ7CD.js";
import "./chunk-A3YG6DDF.js";
import "./chunk-KMWBPJIG.js";
...
import "./chunk-7EV4IMVD.js";
import {
  init_es
} from "./chunk-H2UVDSJD.js";
import "./chunk-F62DJTWJ.js";
import "./chunk-ADDJHDEJ.js";
import "./chunk-3ACLPVOX.js";
import "./chunk-CY63Z6PF.js";
import "./chunk-L4L7HN5R.js";
import "./chunk-JG4XYP4Y.js";
import "./chunk-UMEEXEUT.js";
import "./chunk-VGASMH7F.js";
import {
  walletIds
...
import {
  ...
  watchTransactions
} from "./chunk-KZTIWPD2.js";
import {
  VoteType
} from "./chunk-E3TFATJ7.js";
import {
  TokenERC20History
} from "./chunk-ZRZCJNCV.js";
import {
  StandardErc20
} from "./chunk-DTS35QI3.js";
import {
  ListingType,
  MarketplaceAuction,
  MarketplaceDirect
} from "./chunk-JK2QJBTZ.js";
import {
  hasERC20Allowance
} from "./chunk-ZKJNQWHB.js";
import {
  StandardErc721
} from "./chunk-AYA5P2CQ.js";
import {
  DropErc1155History
} from "./chunk-SWNPPCX7.js";
import {
  PAPER_API_URL,
  PaperCheckout,
...
} from "./chunk-3KKM4OLC.js";
import {
  StandardErc1155
} from "./chunk-QBG5GN6T.js";
import {
  ALL_ROLES,
...
// node_modules/@thirdweb-dev/react/dist/useWalletConnect-a9836c7e.browser.esm.js
init_shim();
    ...
    children: [isMobile() ? (0, import_jsx_runtime.jsx)(Modal, {
      ...
      children: [(0, import_jsx_runtime.jsx)($d08ef79370b62062$export$41fb9f06171c75f4, {
        ...
        children: (0, import_jsx_runtime.jsx)(DropDownContent, {
          asChild: true,
          side: ((_c = props.dropdownPosition) == null ? void 0 : _c.side) || "bottom",
          align: ((_d = props.dropdownPosition) == null ? void 0 : _d.align) || "end",
          sideOffset: 10,
          children: content
        })
      })]
...
var ConnectWallet = (props) => {
  ...
  const signIn = async () => {
    ...
    try {
      ...
      const token = await login((_a2 = props.auth) == null ? void 0 : _a2.loginOptions);
      (_c = (_b = props == null ? void 0 : props.auth) == null ? void 0 : _b.onLogin) == null ? void 0 : _c.call(_b, token);
    } catch (err) {
...
var ModelViewer = (0, import_react14.lazy)(() => import("./ModelViewer-68c3eb38.browser.esm-SZFRFAVT.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
...
var ConnectModal = () => {
  ...
  const isWrapperScreen = typeof screen !== "string" && "config" in screen && !!screen.config.personalWallets;
...
function useMetamask() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    ...
    } = await import("./headlessConnectUI-3fa33622.browser.esm-P5HYFIF2.js").then(function(n) {
      return n.p;
    });
...
function usePaperWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-385de01d.browser.esm-OV5BQDLY.js");
...
function useWalletConnect() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    ...
    } = await import("./walletConnect-b1c1308e.browser.esm-OWTYXVHH.js");
    return connect(walletConnect2(options), options);
  }, [connect]);
}

// node_modules/@thirdweb-dev/react/dist/useSafe-c51d29cc.browser.esm.js
init_shim();
...
function useSafe() {
  ...
  return (0, import_react16.useCallback)(async (connectProps) => {
    ...
    } = await import("./safeWallet-f54dc177.browser.esm-H2A55Z6W.js");
    return connect(safeWallet2(), connectProps);
  }, [connect]);
}

// node_modules/@thirdweb-dev/react/dist/useMagic-969e28f5.browser.esm.js
init_shim();
...
function useMagic() {
  ...
  return (0, import_react17.useCallback)(async (options) => {
    ...
    } = await import("./magicLink-a045cd86.browser.esm-WC753JY7.js");
...
function useLocalWalletInfo(localWalletConfig) {
...
var ImportLocalWallet = (props) => {
  ...
  const {
    setLocalWallet,
    meta
  } = useLocalWalletInfo(props.localWalletConf);
  const createWalletInstance = useCreateWalletInstance();
...
var CreateLocalWallet_Guest = (props) => {
  ...
  const handleConnect = (0, import_react18.useCallback)(async () => {
    ...
    setConnectedWallet(localWallet2);
    onConnect();
  }, [localWallet2, setConnectedWallet, onConnect]);
...
var LocalWalletConnectUI = (props) => {
  const {
    walletData
  } = useLocalWalletInfo(props.walletConfig);
...
var smartWallet = (config) => {
  return {
    ...
    config: {
      ...config,
      personalWallets: (config == null ? void 0 : config.personalWallets) || defaultWallets
    }
  };
};
