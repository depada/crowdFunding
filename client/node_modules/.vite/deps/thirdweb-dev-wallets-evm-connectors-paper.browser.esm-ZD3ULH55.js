...
var PaperWalletConnector = class extends Connector {
  ...
  async connect(options) {
    ...
    switch (user.status) {
      ...
      case G.LOGGED_IN_WALLET_INITIALIZED: {
        this.user = user;
        break;
      }
    }
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-paper.browser.esm-ZD3ULH55.js.map
