import {
  ...
  require_x25519,
  signJWT
} from "./chunk-A3YG6DDF.js";
import {
  require_src,
  require_src2,
  require_src3
} from "./chunk-KMWBPJIG.js";
import {
...
import {
  ...
  safeJsonParse,
  safeJsonStringify
} from "./chunk-H2UVDSJD.js";
import {
  WagmiAdapter
} from "./chunk-ADDJHDEJ.js";
import {
  require_events
...
// node_modules/@thirdweb-dev/wallets/node_modules/query-string/index.js
var require_query_string = __commonJS({
  "node_modules/@thirdweb-dev/wallets/node_modules/query-string/index.js"(exports) {
    "use strict";
    init_shim();
...
function unfetch_module_default(e, n3) {
  return n3 = n3 || {}, new Promise(function(t, r) {
    var s = new XMLHttpRequest(), o2 = [], u5 = [], i4 = {}, a3 = function() {
      return { ok: 2 == (s.status / 100 | 0), statusText: s.statusText, status: s.status, url: s.responseURL, text: function() {
        ...
        return i4[e2.toLowerCase()];
      }, has: function(e2) {
        return e2.toLowerCase() in i4;
      } } };
    };
    for (var l2 in s.open(n3.method || "get", e, true), s.onload = function() {
      s.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, function(e2, n4, t2) {
        o2.push(n4 = n4.toLowerCase()), u5.push([n4, t2]), i4[n4] = i4[n4] ? i4[n4] + "," + t2 : t2;
      }), t(a3());
  ...
  "node_modules/@walletconnect/utils/node_modules/bn.js/lib/bn.js"(exports, module) {
    ...
    (function(module2, exports2) {
      ...
      BN2.prototype._initArray = function _initArray(number, base, endian) {
        ...
        var off = 0;
        if (endian === "be") {
          for (i4 = number.length - 1, j6 = 0; i4 >= 0; i4 -= 3) {
            w4 = number[i4] | number[i4 - 1] << 8 | number[i4 - 2] << 16;
            this.words[j6] |= w4 << off & 67108863;
            this.words[j6 + 1] = w4 >>> 26 - off & 67108863;
            off += 24;
            if (off >= 26) {
              off -= 26;
              j6++;
          ...
          for (i4 = 0, j6 = 0; i4 < number.length; i4 += 3) {
            w4 = number[i4] | number[i4 + 1] << 8 | number[i4 + 2] << 16;
            this.words[j6] |= w4 << off & 67108863;
            this.words[j6 + 1] = w4 >>> 26 - off & 67108863;
            off += 24;
      ...
      BN2.prototype._parseHex = function _parseHex(number, start) {
        ...
        var j6, w4;
        var off = 0;
        for (i4 = number.length - 6, j6 = 0; i4 >= start; i4 -= 6) {
          w4 = parseHex(number, i4, i4 + 6);
          this.words[j6] |= w4 << off & 67108863;
          this.words[j6 + 1] |= w4 >>> 26 - off & 4194303;
          off += 24;
          if (off >= 26) {
            off -= 26;
            j6++;
      ...
      BN2.prototype.toString = function toString2(base, padding) {
        ...
        if (base === (base | 0) && base >= 2 && base <= 36) {
          ...
          c4.negative = 0;
          while (!c4.isZero()) {
            var r = c4.modn(groupBase).toString(base);
      ...
      BN2.prototype.iadd = function iadd(num) {
        ...
        var carry = 0;
        for (var i4 = 0; i4 < b5.length; i4++) {
          r = (a3.words[i4] | 0) + (b5.words[i4] | 0) + carry;
          this.words[i4] = r & 67108863;
          carry = r >>> 26;
        }
        for (; carry !== 0 && i4 < a3.length; i4++) {
          r = (a3.words[i4] | 0) + carry;
          this.words[i4] = r & 67108863;
          carry = r >>> 26;
        }
        this.length = a3.length;
      ...
      function smallMulTo(self2, num, out) {
        ...
        for (var k5 = 1; k5 < len; k5++) {
          ...
          for (var j6 = Math.max(0, k5 - self2.length + 1); j6 <= maxJ; j6++) {
            var i4 = k5 - j6 | 0;
            a3 = self2.words[i4] | 0;
            b5 = num.words[j6] | 0;
            r = a3 * b5 + rword;
      ...
      FFTM.prototype.makeRBT = function makeRBT(N8) {
        var t = new Array(N8);
        var l2 = BN2.prototype._countBits(N8) - 1;
        for (var i4 = 0; i4 < N8; i4++) {
          t[i4] = this.revBin(i4, l2, N8);
        }
        return t;
      };
      FFTM.prototype.revBin = function revBin(x5, l2, N8) {
        if (x5 === 0 || x5 === N8 - 1)
          return x5;
        var rb = 0;
      ...
      FFTM.prototype.guessLen13b = function guessLen13b(n3, m7) {
        var N8 = Math.max(m7, n3) | 1;
        var odd = N8 & 1;
        var i4 = 0;
      ...
      FFTM.prototype.normalize13b = function normalize13b(ws3, N8) {
        var carry = 0;
        for (var i4 = 0; i4 < N8 / 2; i4++) {
          var w4 = Math.round(ws3[2 * i4 + 1] / N8) * 8192 + Math.round(ws3[2 * i4] / N8) + carry;
          ws3[i4] = w4 & 67108863;
          if (w4 < 67108864) {
            carry = 0;
          } else {
      ...
      FFTM.prototype.convert13b = function convert13b(ws3, len, rws, N8) {
        var carry = 0;
      ...
      FFTM.prototype.mulp = function mulp(x5, y4, out) {
        var N8 = 2 * this.guessLen13b(x5.length, y4.length);
        ...
        var rmws = out.words;
        rmws.length = N8;
        this.convert13b(x5.words, x5.length, rws, N8);
        this.convert13b(y4.words, y4.length, nrws, N8);
        this.transform(rws, _5, rwst, iwst, N8, rbt);
        this.transform(nrws, _5, nrwst, niwst, N8, rbt);
        for (var i4 = 0; i4 < N8; i4++) {
        ...
        this.transform(rwst, iwst, rmws, _5, N8, rbt);
        this.conjugate(rmws, _5, N8);
        this.normalize13b(rmws, N8);
        out.negative = x5.negative ^ y4.negative;
        out.length = x5.length + y4.length;
        return out.strip();
      };
      ...
      BN2.prototype.pow = function pow(num) {
        ...
        if (++i4 < w4.length) {
          for (var q8 = res.sqr(); i4 < w4.length; i4++, q8 = q8.sqr()) {
            if (w4[i4] === 0)
              continue;
            res = res.mul(q8);
          }
      ...
      BN2.prototype.iushln = function iushln(bits) {
        ...
        if (r !== 0) {
          ...
          for (i4 = 0; i4 < this.length; i4++) {
            ...
            var c4 = (this.words[i4] | 0) - newCarry << r;
      ...
      BN2.prototype.iushrn = function iushrn(bits, hint, extended) {
        ...
        for (i4 = this.length - 1; i4 >= 0 && (carry !== 0 || i4 >= h3); i4--) {
          ...
          this.words[i4] = carry << 26 - r | word >>> r;
          carry = word & mask;
        }
      ...
      BN2.prototype._wordDiv = function _wordDiv(num, mode) {
        ...
        var m7 = a3.length - b5.length;
        var q8;
        if (mode !== "mod") {
          q8 = new BN2(null);
          q8.length = m7 + 1;
          q8.words = new Array(q8.length);
          for (var i4 = 0; i4 < q8.length; i4++) {
            q8.words[i4] = 0;
          }
        }
        var diff = a3.clone()._ishlnsubmul(b5, 1, m7);
        if (diff.negative === 0) {
          a3 = diff;
          if (q8) {
            q8.words[m7] = 1;
      ...
      BN2.prototype.bincn = function bincn(bit) {
        ...
        var carry = q8;
        for (var i4 = s; carry !== 0 && i4 < this.length; i4++) {
      ...
      BN2.prototype.gt = function gt4(num) {
      ...
      BN2.prototype.lt = function lt6(num) {
        return this.cmp(num) === -1;
      };
      ...
      function Red(m7) {
        if (typeof m7 === "string") {
          var prime = BN2._prime(m7);
          this.m = prime.p;
          this.prime = prime;
        } else {
          assert(m7.gtn(1), "modulus must be greater than 1");
          this.m = m7;
          this.prime = null;
        }
      }
      ...
      Red.prototype.sqrt = function sqrt(a3) {
        ...
        var c4 = this.pow(z5, q8);
        var r = this.pow(a3, q8.addn(1).iushrn(1));
        var t = this.pow(a3, q8);
        var m7 = s;
        while (t.cmp(one) !== 0) {
          var tmp = t;
          ...
          assert(i4 < m7);
          var b5 = this.pow(c4, new BN2(1).iushln(m7 - i4 - 1));
          r = r.redMul(b5);
          c4 = b5.redSqr();
          t = t.redMul(c4);
          m7 = i4;
      ...
      Red.prototype.pow = function pow(a3, num) {
        ...
        for (i4 = num.length - 1; i4 >= 0; i4--) {
          ...
          for (var j6 = start - 1; j6 >= 0; j6--) {
            ...
            current |= bit;
            currentLen++;
            if (currentLen !== windowSize && (i4 !== 0 || j6 !== 0))
              continue;
      ...
      Mont.prototype.imul = function imul(a3, b5) {
        ...
        var u5 = t.isub(c4).iushrn(this.shift);
        var res = u5;
        if (u5.cmp(this.m) >= 0) {
          res = u5.isub(this.m);
        } else if (u5.cmpn(0) < 0) {
...
// node_modules/@thirdweb-dev/wallets/dist/smart-wallet-d9c35403.browser.esm.js
init_shim();
...
function Q(e) {
  ...
  if (j(t) === U) {
    const d5 = r + J, l2 = d5 + W, i4 = n3.slice(r, d5), u5 = n3.slice(d5, l2), a3 = n3.slice(l2);
    return { type: t, sealed: a3, iv: u5, senderPublicKey: i4 };
  }
  const o2 = r + W, s = n3.slice(r, o2), c4 = n3.slice(o2);
  return { type: t, sealed: c4, iv: s };
}
function $n(e, n3) {
  const t = Q(e);
...
function Hn({ protocol: e, version: n3, relayUrl: t, sdkVersion: r, auth: o2, projectId: s, useOnCloseEvent: c4 }) {
  const d5 = t.split("?"), l2 = Me(e, n3, r), i4 = { auth: o2, ua: l2, projectId: s, useOnCloseEvent: c4 || void 0 }, u5 = $e(d5[1] || "", i4);
  return d5[0] + "?" + u5;
}
function Gn(e) {
...
function Zn(e = import_time.FIVE_MINUTES, n3) {
  ...
  let r, o2, s;
  return { resolve: (c4) => {
    s && r && (clearTimeout(s), r(c4));
  }, reject: (c4) => {
    s && o2 && (clearTimeout(s), o2(c4));
  }, done: () => new Promise((c4, d5) => {
    s = setTimeout(() => {
      d5(new Error(n3));
    }, t), r = c4, o2 = d5;
  }) };
...
function qe(e, n3 = "-") {
  ...
  return Object.keys(e).forEach((o2) => {
    if (o2.startsWith(r)) {
      const s = o2.replace(r, ""), c4 = e[o2];
      t[s] = c4;
    }
  }), t;
}
function ft(e) {
  const n3 = e.indexOf(":"), t = e.indexOf("?") !== -1 ? e.indexOf("?") : void 0, r = e.substring(0, n3), o2 = e.substring(n3 + 1, t).split("@"), s = typeof t < "u" ? e.substring(t) : "", c4 = $.parse(s);
  return { protocol: r, topic: o2[0], version: parseInt(o2[1], 10), symKey: c4.symKey, relay: qe(c4) };
}
function ze(e, n3 = "-") {
  const t = "relay", r = {};
  return Object.keys(e).forEach((o2) => {
...
function Ai(r, e) {
  ...
  function g5(u5) {
    ...
    if (u5.length === 0)
      return "";
    for (var y4 = 0, O4 = 0, w4 = 0, _5 = u5.length; w4 !== _5 && u5[w4] === 0; )
      w4++, y4++;
    for (var R6 = (_5 - w4) * l2 + 1 >>> 0, b5 = new Uint8Array(R6); w4 !== _5; ) {
      for (var S8 = u5[w4], x5 = 0, v = R6 - 1; (S8 !== 0 || x5 < O4) && v !== -1; v--, x5++)
        S8 += 256 * b5[v] >>> 0, b5[v] = S8 % o2 >>> 0, S8 = S8 / o2 >>> 0;
      if (S8 !== 0)
        throw new Error("Non-zero carry");
      O4 = x5, w4++;
    }
    for (var T4 = R6 - O4; T4 !== R6 && b5[T4] === 0; )
      T4++;
    for (var K4 = h3.repeat(y4); T4 < R6; ++T4)
      K4 += r.charAt(b5[T4]);
    return K4;
  }
  function L5(u5) {
    ...
    var y4 = 0;
    if (u5[y4] !== " ") {
      for (var O4 = 0, w4 = 0; u5[y4] === h3; )
        O4++, y4++;
      for (var _5 = (u5.length - y4) * d5 + 1 >>> 0, R6 = new Uint8Array(_5); u5[y4]; ) {
        var b5 = t[u5.charCodeAt(y4)];
        if (b5 === 255)
          return;
        for (var S8 = 0, x5 = _5 - 1; (b5 !== 0 || S8 < w4) && x5 !== -1; x5--, S8++)
          b5 += o2 * R6[x5] >>> 0, R6[x5] = b5 % 256 >>> 0, b5 = b5 / 256 >>> 0;
        if (b5 !== 0)
          throw new Error("Non-zero carry");
        w4 = S8, y4++;
      }
      if (u5[y4] !== " ") {
        for (var v = _5 - w4; v !== _5 && R6[v] === 0; )
          v++;
        for (var T4 = new Uint8Array(O4 + (_5 - v)), K4 = O4; v !== _5; )
          T4[K4++] = R6[v++];
        return T4;
      }
    }
  ...
  return { encode: g5, decodeUnsafe: L5, decode: X8 };
}
var zi = Ai;
var Ni = zi;
var Te2 = (r) => {
...
var Ki = class {
  constructor(e, t, i4, s) {
    this.name = e, this.prefix = t, this.baseEncode = i4, this.baseDecode = s, this.encoder = new Fi(e, t, i4), this.decoder = new $i(e, t, s);
  }
  encode(e) {
...
var G2 = ({ name: r, prefix: e, encode: t, decode: i4 }) => new Ki(r, e, t, i4);
var $2 = ({ prefix: r, name: e, alphabet: t }) => {
  const { encode: i4, decode: s } = Ni(t, e);
  return G2({ prefix: r, name: e, encode: i4, decode: (n3) => Te2(s(n3)) });
};
var Bi = (r, e, t, i4) => {
  const s = {};
...
var ki = (r, e, t) => {
  const i4 = e[e.length - 1] === "=", s = (1 << t) - 1;
  let n3 = "", a3 = 0, o2 = 0;
  for (let h3 = 0; h3 < r.length; ++h3)
    for (o2 = o2 << 8 | r[h3], a3 += 8; a3 > t; )
      a3 -= t, n3 += e[s & o2 >> a3];
  if (a3 && (n3 += e[s & o2 << t - a3]), i4)
    for (; n3.length * t & 7; )
      n3 += "=";
  return n3;
};
var p2 = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i4 }) => G2({ prefix: e, name: r, encode(s) {
  return ki(s, i4, t);
}, decode(s) {
  return Bi(s, i4, t, r);
} });
...
var ae2 = (r, e) => {
  const t = e.byteLength, i4 = Le(r), s = i4 + Le(t), n3 = new Uint8Array(s + t);
  return Ue2(r, n3, 0), Ue2(t, n3, i4), n3.set(e, s), new Vs(r, t, e, n3);
};
var Vs = class {
  constructor(e, t, i4, s) {
    this.code = e, this.size = t, this.digest = i4, this.bytes = s;
  }
};
...
var qs = class {
  ...
  digest(e) {
    if (e instanceof Uint8Array) {
      ...
      return t instanceof Uint8Array ? ae2(this.code, t) : t.then((i4) => ae2(this.code, i4));
    } else
      throw Error("Unknown type, must be binary type");
  }
};
...
function je2(r, e, t, i4) {
  return { name: r, prefix: e, encoder: { name: r, prefix: e, encode: t }, decoder: { decode: i4 } };
}
...
var mt = class {
  constructor(e, t) {
    ...
    }, this.has = (i4) => (this.isInitialized(), this.keychain.has(i4)), this.set = async (i4, s) => {
      this.isInitialized(), this.keychain.set(i4, s), await this.persist();
    }, this.get = (i4) => {
      this.isInitialized();
      const s = this.keychain.get(i4);
      if (typeof s > "u") {
...
var ft2 = class {
  constructor(e, t, i4) {
    this.core = e, this.logger = t, this.name = Je, this.initialized = false, this.init = async () => {
      ...
      if (Dn(o2)) {
        const L5 = o2.senderPublicKey, X8 = o2.receiverPublicKey;
        s = await this.generateSharedKey(L5, X8);
      }
    ...
    }, this.core = e, this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.keychain = i4 || new mt(this.core, this.logger);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var Et = class extends a {
  constructor(e, t) {
    super(e, t), this.logger = e, this.core = t, this.messages = /* @__PURE__ */ new Map(), this.name = Ze, this.version = Qe, this.initialized = false, this.storagePrefix = P, this.init = async () => {
      ...
      return typeof a3 > "u" && (a3 = {}), typeof a3[n3] < "u" || (a3[n3] = s, this.messages.set(i4, a3), await this.persist()), n3;
    }, this.get = (i4) => {
      this.isInitialized();
      let s = this.messages.get(i4);
      return typeof s > "u" && (s = {}), s;
    }, this.has = (i4, s) => {
      this.isInitialized();
      const n3 = this.get(i4), a3 = wn(s);
...
var ar = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events4.EventEmitter(), this.name = tt2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = 1e4, this.publish = async (i4, s, n3) => {
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i4, message: s, opts: n3 } });
      try {
        const a3 = (n3 == null ? void 0 : n3.ttl) || et2, o2 = it(n3), h3 = (n3 == null ? void 0 : n3.prompt) || false, d5 = (n3 == null ? void 0 : n3.tag) || 0, l2 = { topic: i4, message: s, opts: { ttl: a3, relay: o2, prompt: h3, tag: d5 } }, g5 = wn(s);
        this.queue.set(g5, l2);
        try {
          await await Xn(this.rpcPublish(i4, s, a3, o2, h3, d5), this.publishTimeout), this.relayer.events.emit(D.publish, l2);
        } catch {
          this.logger.debug("Publishing Payload stalled"), this.relayer.events.emit(D.connection_stalled);
          return;
        }
        this.onPublish(g5, l2), this.logger.debug("Successfully Published Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i4, message: s, opts: n3 } });
      } catch (a3) {
      ...
      this.events.once(i4, s);
    }, this.off = (i4, s) => {
      this.events.off(i4, s);
    }, this.removeListener = (i4, s) => {
      this.events.removeListener(i4, s);
    }, this.relayer = e, this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.registerEventListeners();
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
  rpcPublish(e, t, i4, s, n3, a3) {
    var o2, h3, d5, l2;
    const g5 = { method: ct(s.protocol).publish, params: { topic: e, message: t, ttl: i4, prompt: n3, tag: a3 } };
  ...
  checkQueue() {
    this.queue.forEach(async (e) => {
      const { topic: t, message: i4, opts: s } = e;
      await this.publish(t, i4, s);
    });
  }
...
var It2 = class extends d {
  constructor(e, t) {
    ...
    }, this.subscribe = async (i4, s) => {
      await this.restartToComplete(), this.isInitialized(), this.logger.debug("Subscribing Topic"), this.logger.trace({ type: "method", method: "subscribe", params: { topic: i4, opts: s } });
      try {
        const n3 = it(s), a3 = { topic: i4, relay: n3 };
        this.pending.set(i4, a3);
        const o2 = await this.rpcSubscribe(i4, n3);
        return this.onSubscribe(o2, a3), this.logger.debug("Successfully Subscribed Topic"), this.logger.trace({ type: "method", method: "subscribe", params: { topic: i4, opts: s } }), o2;
      } catch (n3) {
        throw this.logger.debug("Failed to Subscribe Topic"), this.logger.error(n3), n3;
      }
    }, this.unsubscribe = async (i4, s) => {
      await this.restartToComplete(), this.isInitialized(), typeof (s == null ? void 0 : s.id) < "u" ? await this.unsubscribeById(i4, s.id, s) : await this.unsubscribeByTopic(i4, s);
    }, this.isSubscribed = async (i4) => this.topics.includes(i4) ? true : await new Promise((s, n3) => {
      const a3 = new import_time2.Watch();
      a3.start(this.pendingSubscriptionWatchLabel);
      const o2 = setInterval(() => {
        !this.pending.has(i4) && this.topics.includes(i4) && (clearInterval(o2), a3.stop(this.pendingSubscriptionWatchLabel), s(true)), a3.elapsed(this.pendingSubscriptionWatchLabel) >= lt2 && (clearInterval(o2), a3.stop(this.pendingSubscriptionWatchLabel), n3(false));
  ...
  async unsubscribeByTopic(e, t) {
    ...
    await Promise.all(i4.map(async (s) => await this.unsubscribeById(e, s, t)));
  }
  ...
  async rpcSubscribe(e, t) {
    const i4 = { method: ct(t.protocol).subscribe, params: { topic: e } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i4 });
    try {
      await await Xn(this.relayer.request(i4), this.subscribeTimeout);
    } catch {
  ...
  async rpcBatchSubscribe(e) {
    if (!e.length)
      return;
    const t = e[0].relay, i4 = { method: ct(t.protocol).batchSubscribe, params: { topics: e.map((s) => s.topic) } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i4 });
    try {
      return await await Xn(this.relayer.request(i4), this.subscribeTimeout);
    } catch {
      this.logger.debug("Outgoing Relay Payload stalled"), this.relayer.events.emit(D.connection_stalled);
    }
  }
  rpcUnsubscribe(e, t, i4) {
    const s = { method: ct(i4.protocol).unsubscribe, params: { topic: e, id: t } };
  ...
  getSubscription(e) {
    ...
    if (!t) {
      const { message: i4 } = N("NO_MATCHING_KEY", `${this.name}: ${e}`);
      throw new Error(i4);
    }
    return t;
  }
  deleteSubscription(e, t) {
    ...
    this.subscriptions.delete(e), this.topicMap.delete(i4.topic, e), this.events.emit(I.deleted, de(M({}, i4), { reason: t }));
  }
  async persist() {
  ...
  async batchSubscribe(e) {
    ...
    C(t) && this.onBatchSubscribe(t.map((i4, s) => de(M({}, e[s]), { id: i4 })));
  }
  async onConnect() {
...
var Rt2 = class extends g {
  ...
  async publish(e, t, i4) {
    this.isInitialized(), await this.publisher.publish(e, t, i4), await this.recordMessageEvent({ topic: e, message: t, publishedAt: Date.now() });
  }
  async subscribe(e, t) {
    this.isInitialized();
    let i4 = "";
    return await Promise.all([new Promise((s) => {
      ...
      i4 = await this.subscriber.subscribe(e, t), s();
    })]), i4;
  }
  ...
  async transportOpen(e) {
    if (this.transportExplicitlyClosed = false, !this.reconnecting) {
      ...
      try {
        ...
        }), await Promise.race([new Promise(async (t, i4) => {
          await Xn(this.provider.connect(), 5e3, "socket stalled").catch((s) => i4(s)).then(() => t()).finally(() => this.removeListener(D.transport_closed, this.rejectTransportOpen));
  ...
  async shouldIgnoreMessageEvent(e) {
    const { topic: t, message: i4 } = e;
    return await this.subscriber.isSubscribed(t) ? this.messages.has(t, i4) : true;
  }
  async onProviderPayload(e) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e }), isJsonRpcRequest(e)) {
      if (!e.method.endsWith(nt2))
        return;
      const t = e.params, { topic: i4, message: s, publishedAt: n3 } = t.data, a3 = { topic: i4, message: s, publishedAt: n3 };
...
var xt = class extends p {
  constructor(e, t, i4, s = P, n3 = void 0) {
    super(e, t, i4, s), this.core = e, this.logger = t, this.name = i4, this.map = /* @__PURE__ */ new Map(), this.version = ht, this.cached = [], this.initialized = false, this.storagePrefix = P, this.init = async () => {
...
var Ot = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = dt2, this.version = gt, this.events = new import_events4.default(), this.initialized = false, this.storagePrefix = P, this.ignoredPayloadTypes = [U], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i4 = An(), s = await this.core.crypto.setSymKey(i4), n3 = rt(import_time2.FIVE_MINUTES), a3 = { protocol: it2 }, o2 = { topic: s, expiry: n3, relay: a3, active: false }, h3 = pt({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i4, relay: a3 });
      ...
      const { topic: s, symKey: n3, relay: a3 } = ft(i4.uri);
      ...
      return await this.pairings.set(s, h3), await this.core.crypto.setSymKey(n3, s), await this.core.relayer.subscribe(s, { relay: a3 }), this.core.expirer.set(s, o2), i4.activatePairing && await this.activate({ topic: s }), h3;
    }, this.activate = async ({ topic: i4 }) => {
      this.isInitialized();
      const s = rt(import_time2.THIRTY_DAYS);
      await this.pairings.update(i4, { active: true, expiry: s }), this.core.expirer.set(i4, s);
    }, this.ping = async (i4) => {
    ...
    }, this.updateExpiry = async ({ topic: i4, expiry: s }) => {
      this.isInitialized(), await this.pairings.update(i4, { expiry: s });
    }, this.updateMetadata = async ({ topic: i4, metadata: s }) => {
      this.isInitialized(), await this.pairings.update(i4, { peerMetadata: s });
    ...
    }, this.sendRequest = async (i4, s, n3) => {
      const a3 = formatJsonRpcRequest(s, n3), o2 = await this.core.crypto.encode(i4, a3), h3 = U2[s].req;
      return this.core.history.set(i4, a3), await this.core.relayer.publish(i4, o2, h3), a3.id;
    }, this.sendResult = async (i4, s, n3) => {
      const a3 = formatJsonRpcResult(i4, n3), o2 = await this.core.crypto.encode(s, a3), h3 = await this.core.history.get(s, i4), d5 = U2[h3.request.method].res;
      await this.core.relayer.publish(s, o2, d5), await this.core.history.resolve(a3);
    }, this.sendError = async (i4, s, n3) => {
      const a3 = formatJsonRpcError(i4, n3), o2 = await this.core.crypto.encode(s, a3), h3 = await this.core.history.get(s, i4), d5 = U2[h3.request.method] ? U2[h3.request.method].res : U2.unregistered_method.res;
      await this.core.relayer.publish(s, o2, d5), await this.core.history.resolve(a3);
    }, this.deletePairing = async (i4, s) => {
      await this.core.relayer.unsubscribe(i4), await Promise.all([this.pairings.delete(i4, R("USER_DISCONNECTED")), this.core.crypto.deleteSymKey(i4), s ? Promise.resolve() : this.core.expirer.del(i4)]);
    }, this.cleanup = async () => {
      const i4 = this.pairings.getAll().filter((s) => ot(s.expiry));
      await Promise.all(i4.map((s) => this.deletePairing(s.topic)));
    }, this.onRelayEventRequest = (i4) => {
      const { topic: s, payload: n3 } = i4, a3 = n3.method;
      if (this.pairings.keys.includes(s))
        switch (a3) {
          case "wc_pairingPing":
      ...
      const { topic: s, payload: n3 } = i4, a3 = (await this.core.history.get(s, n3.id)).request.method;
      if (this.pairings.keys.includes(s))
        switch (a3) {
          case "wc_pairingPing":
    ...
    }, this.onPairingPingRequest = async (i4, s) => {
      const { id: n3 } = s;
      try {
        this.isValidPing({ topic: i4 }), await this.sendResult(n3, i4, true), this.events.emit("pairing_ping", { id: n3, topic: i4 });
      } catch (a3) {
        await this.sendError(n3, i4, a3), this.logger.error(a3);
      }
    }, this.onPairingPingResponse = (i4, s) => {
      const { id: n3 } = s;
      setTimeout(() => {
        isJsonRpcResult(s) ? this.events.emit(st("pairing_ping", n3), {}) : isJsonRpcError(s) && this.events.emit(st("pairing_ping", n3), { error: s.error });
      }, 500);
    }, this.onPairingDeleteRequest = async (i4, s) => {
      const { id: n3 } = s;
      try {
        this.isValidDisconnect({ topic: i4 }), await this.deletePairing(i4), this.events.emit("pairing_delete", { id: n3, topic: i4 });
      } catch (a3) {
        await this.sendError(n3, i4, a3), this.logger.error(a3);
      }
    }, this.onUnknownRpcMethodRequest = async (i4, s) => {
      ...
      this.registeredMethods.includes(i4) || this.logger.error(R("WC_METHOD_UNSUPPORTED", i4));
    }, this.isValidPair = (i4) => {
      if (!Ct(i4)) {
        const { message: s } = N("MISSING_OR_INVALID", `pair() params: ${i4}`);
        throw new Error(s);
      }
      if (!Tt(i4.uri)) {
        const { message: s } = N("MISSING_OR_INVALID", `pair() uri: ${i4.uri}`);
        throw new Error(s);
      }
      ...
      if (!m(i4, false)) {
        const { message: s } = N("MISSING_OR_INVALID", `pairing topic should be a string: ${i4}`);
        throw new Error(s);
      }
      if (!this.pairings.keys.includes(i4)) {
        const { message: s } = N("NO_MATCHING_KEY", `pairing topic doesn't exist: ${i4}`);
        throw new Error(s);
      }
      if (ot(this.pairings.get(i4).expiry)) {
        await this.deletePairing(i4);
        const { message: s } = N("EXPIRED", `pairing topic: ${i4}`);
        throw new Error(s);
      }
  ...
  registerRelayerEvents() {
    this.core.relayer.on(D.message, async (e) => {
      const { topic: t, message: i4 } = e;
      if (this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(i4)))
        return;
      const s = await this.core.crypto.decode(t, i4);
...
var At2 = class extends h {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events4.EventEmitter(), this.name = pt2, this.version = Dt, this.cached = [], this.initialized = false, this.storagePrefix = P, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i4, request: s, chainId: n3 }), this.records.has(s.id))
        return;
      const a3 = { id: s.id, topic: i4, request: { method: s.method, params: s.params || null }, chainId: n3 };
      ...
      if (this.isInitialized(), this.logger.debug("Updating JSON-RPC response history record"), this.logger.trace({ type: "method", method: "update", response: i4 }), !this.records.has(i4.id))
        return;
      const s = await this.getRecord(i4.id);
      typeof s.response > "u" && (s.response = isJsonRpcError(i4) ? { error: i4.error } : { result: i4.result }, this.records.set(s.id, s), this.events.emit(C2.updated, s));
    }, this.get = async (i4, s) => (this.isInitialized(), this.logger.debug("Getting record"), this.logger.trace({ type: "method", method: "get", topic: i4, id: s }), await this.getRecord(s)), this.delete = (i4, s) => {
    ...
    }, this.exists = async (i4, s) => (this.isInitialized(), this.records.has(s) ? (await this.getRecord(s)).topic === i4 : false), this.on = (i4, s) => {
      this.events.on(i4, s);
    }, this.once = (i4, s) => {
      this.events.once(i4, s);
    }, this.off = (i4, s) => {
...
var zt = class extends E {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events4.EventEmitter(), this.name = yt, this.version = bt, this.cached = [], this.initialized = false, this.storagePrefix = P, this.init = async () => {
      ...
      this.isInitialized();
      const n3 = this.formatTarget(i4), a3 = { target: n3, expiry: s };
      ...
      if (this.isInitialized(), this.has(i4)) {
        const s = this.formatTarget(i4), n3 = this.getExpiration(s);
...
var Nt = class extends y {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = J2, this.initialized = false, this.init = async (i4) => {
      je() || !Ce() || (this.verifyUrl = (i4 == null ? void 0 : i4.verifyUrl) || le2, await this.createIframe());
    }, this.register = async (i4) => {
      var s;
      this.initialized || await this.init(), this.iframe && ((s = this.iframe.contentWindow) == null || s.postMessage(i4.attestationId, this.verifyUrl), this.logger.info(`postMessage sent: ${i4.attestationId} ${this.verifyUrl}`));
    }, this.resolve = async (i4) => {
      var s;
      if (this.isDevEnv)
        return "";
      this.logger.info(`resolving attestation: ${i4.attestationId}`);
      const n3 = this.startAbortTimer(import_time2.FIVE_SECONDS), a3 = await fetch(`${this.verifyUrl}/attestation/${i4.attestationId}`, { signal: this.abortController.signal });
      return clearTimeout(n3), a3.status === 200 ? (s = await a3.json()) == null ? void 0 : s.origin : "";
    }, this.createIframe = async () => {
      try {
        await Promise.race([new Promise((i4, s) => {
          ...
          setTimeout(() => i4("iframe load timeout"), (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND / 2));
        })]);
      } catch (i4) {
...
var H = class extends n {
  constructor(e) {
    super(e), this.protocol = he, this.version = qe2, this.name = Y2, this.events = new import_events4.EventEmitter(), this.initialized = false, this.on = (i4, s) => this.events.on(i4, s), this.once = (i4, s) => this.events.once(i4, s), this.off = (i4, s) => this.events.off(i4, s), this.removeListener = (i4, s) => this.events.removeListener(i4, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || ue2;
...
var J3 = 32;
function An2() {
  const e = ue3.generateKeyPair();
  return { privateKey: toString(e.secretKey, f3), publicKey: toString(e.publicKey, f3) };
}
function Un2() {
  const e = (0, import_random2.randomBytes)(J3);
  return toString(e, f3);
}
function _n2(e, n3) {
  const t = ue3.sharedKey(fromString(e, f3), fromString(n3, f3)), r = new import_hkdf2.HKDF(import_sha2562.SHA256, t).expand(J3);
  return toString(r, f3);
}
function wn2(e) {
  const n3 = (0, import_sha2562.hash)(fromString(e, f3));
  return toString(n3, f3);
}
function jn2(e) {
  const n3 = (0, import_sha2562.hash)(fromString(e, k2));
  return toString(n3, f3);
}
function Se2(e) {
  return fromString(`${e}`, G3);
}
function j2(e) {
  return Number(toString(e, G3));
}
function Cn2(e) {
  const n3 = Se2(typeof e.type < "u" ? e.type : W3);
  if (j2(n3) === U3 && typeof e.senderPublicKey > "u")
    throw new Error("Missing sender public key for type 1 envelope");
  const t = typeof e.senderPublicKey < "u" ? fromString(e.senderPublicKey, f3) : void 0, r = typeof e.iv < "u" ? fromString(e.iv, f3) : (0, import_random2.randomBytes)(Y3), o2 = new import_chacha20poly13052.ChaCha20Poly1305(fromString(e.symKey, f3)).seal(r, fromString(e.message, k2));
  return Ie3({ type: n3, sealed: o2, iv: r, senderPublicKey: t });
}
function $n2(e) {
  const n3 = new import_chacha20poly13052.ChaCha20Poly1305(fromString(e.symKey, f3)), { sealed: t, iv: r } = Q2(e.encoded), o2 = n3.open(r, t);
  if (o2 === null)
    throw new Error("Failed to decrypt");
...
function Q2(e) {
  ...
  if (j2(t) === U3) {
    const d5 = r + J3, l2 = d5 + Y3, i4 = n3.slice(r, d5), u5 = n3.slice(d5, l2), a3 = n3.slice(l2);
    return { type: t, sealed: a3, iv: u5, senderPublicKey: i4 };
  }
  const o2 = r + Y3, s = n3.slice(r, o2), c4 = n3.slice(o2);
  return { type: t, sealed: c4, iv: s };
}
function Dn2(e, n3) {
  const t = Q2(e);
  return Pe3({ type: j2(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString(t.senderPublicKey, f3) : void 0, receiverPublicKey: n3 == null ? void 0 : n3.receiverPublicKey });
}
function Pe3(e) {
  const n3 = (e == null ? void 0 : e.type) || W3;
  if (n3 === U3) {
    if (typeof (e == null ? void 0 : e.senderPublicKey) > "u")
      throw new Error("missing sender public key");
    if (typeof (e == null ? void 0 : e.receiverPublicKey) > "u")
...
function Vn2(e) {
  return e.type === U3 && typeof e.senderPublicKey == "string" && typeof e.receiverPublicKey == "string";
}
var Mn2 = Object.defineProperty;
var Te3 = Object.getOwnPropertySymbols;
var Kn2 = Object.prototype.hasOwnProperty;
var kn = Object.prototype.propertyIsEnumerable;
var Re2 = (e, n3, t) => n3 in e ? Mn2(e, n3, { enumerable: true, configurable: true, writable: true, value: t }) : e[n3] = t;
var Ae3 = (e, n3) => {
  for (var t in n3 || (n3 = {}))
    Kn2.call(n3, t) && Re2(e, t, n3[t]);
  if (Te3)
    for (var t of Te3(n3))
      kn.call(n3, t) && Re2(e, t, n3[t]);
  return e;
};
var Ue3 = "ReactNative";
var _2 = { reactNative: "react-native", node: "node", browser: "browser", unknown: "unknown" };
var we3 = "js";
function X2() {
  return typeof import_process.default < "u" && typeof import_process.default.versions < "u" && typeof import_process.default.versions.node < "u";
}
...
function Ce2() {
  return !X2() && !!(0, import_window_getters2.getNavigator)();
}
function ee2() {
  return je3() ? _2.reactNative : X2() ? _2.node : Ce2() ? _2.browser : _2.unknown;
}
function $e3(e, n3) {
  let t = $3.parse(e);
  return t = Ae3(Ae3({}, t), n3), e = $3.stringify(t), e;
}
function De2() {
  const e = detect();
  if (e === null)
...
function Ve3() {
  var e;
  const n3 = ee2();
  return n3 === _2.browser ? [n3, ((e = (0, import_window_getters2.getLocation)()) == null ? void 0 : e.host) || "unknown"].join(":") : n3;
}
function Me3(e, n3, t) {
  const r = De2(), o2 = Ve3();
  return [[e, n3].join("-"), [we3, t].join("-"), r, o2].join("/");
}
function qn({ protocol: e, version: n3, relayUrl: t, sdkVersion: r, auth: o2, projectId: s, useOnCloseEvent: c4 }) {
  const d5 = t.split("?"), l2 = Me3(e, n3, r), i4 = { auth: o2, ua: l2, projectId: s, useOnCloseEvent: c4 || void 0 }, u5 = $e3(d5[1] || "", i4);
  return d5[0] + "?" + u5;
}
function Wn(e) {
  return Object.fromEntries(e.entries());
...
function Xn2(e = import_time3.FIVE_MINUTES, n3) {
...
function ot3(e, n3) {
  return (0, import_time3.fromMiliseconds)((n3 || Date.now()) + (0, import_time3.toMiliseconds)(e));
}
function st3(e) {
...
var xe3 = "irn";
function ct3(e) {
  return (e == null ? void 0 : e.relay) || { protocol: xe3 };
}
function at3(e) {
  const n3 = RELAY_JSONRPC[e];
  if (typeof n3 > "u")
...
var Fe3 = Object.getOwnPropertySymbols;
var dt3 = Object.prototype.hasOwnProperty;
var lt3 = Object.prototype.propertyIsEnumerable;
var He3 = (e, n3, t) => n3 in e ? ut3(e, n3, { enumerable: true, configurable: true, writable: true, value: t }) : e[n3] = t;
var ft3 = (e, n3) => {
  for (var t in n3 || (n3 = {}))
    dt3.call(n3, t) && He3(e, t, n3[t]);
  if (Fe3)
    for (var t of Fe3(n3))
      lt3.call(n3, t) && He3(e, t, n3[t]);
  return e;
};
function qe3(e, n3 = "-") {
  const t = {}, r = "relay" + n3;
...
function pt3(e) {
  const n3 = e.indexOf(":"), t = e.indexOf("?") !== -1 ? e.indexOf("?") : void 0, r = e.substring(0, n3), o2 = e.substring(n3 + 1, t).split("@"), s = typeof t < "u" ? e.substring(t) : "", c4 = $3.parse(s);
  return { protocol: r, topic: ze3(o2[0]), version: parseInt(o2[1], 10), symKey: c4.symKey, relay: qe3(c4) };
}
function ze3(e) {
...
function mt2(e) {
  return `${e.protocol}:${e.topic}@${e.version}?` + $3.stringify(ft3({ symKey: e.symKey }, Be2(e.relay)));
}
var It3 = { INVALID_METHOD: { message: "Invalid method.", code: 1001 }, INVALID_EVENT: { message: "Invalid event.", code: 1002 }, INVALID_UPDATE_REQUEST: { message: "Invalid update request.", code: 1003 }, INVALID_EXTEND_REQUEST: { message: "Invalid extend request.", code: 1004 }, INVALID_SESSION_SETTLE_REQUEST: { message: "Invalid session settle request.", code: 1005 }, UNAUTHORIZED_METHOD: { message: "Unauthorized method.", code: 3001 }, UNAUTHORIZED_EVENT: { message: "Unauthorized event.", code: 3002 }, UNAUTHORIZED_UPDATE_REQUEST: { message: "Unauthorized update request.", code: 3003 }, UNAUTHORIZED_EXTEND_REQUEST: { message: "Unauthorized extend request.", code: 3004 }, USER_REJECTED: { message: "User rejected.", code: 5e3 }, USER_REJECTED_CHAINS: { message: "User rejected chains.", code: 5001 }, USER_REJECTED_METHODS: { message: "User rejected methods.", code: 5002 }, USER_REJECTED_EVENTS: { message: "User rejected events.", code: 5003 }, UNSUPPORTED_CHAINS: { message: "Unsupported chains.", code: 5100 }, UNSUPPORTED_METHODS: { message: "Unsupported methods.", code: 5101 }, UNSUPPORTED_EVENTS: { message: "Unsupported events.", code: 5102 }, UNSUPPORTED_ACCOUNTS: { message: "Unsupported accounts.", code: 5103 }, UNSUPPORTED_NAMESPACE_KEY: { message: "Unsupported namespace key.", code: 5104 }, USER_DISCONNECTED: { message: "User disconnected.", code: 6e3 }, SESSION_SETTLEMENT_FAILED: { message: "Session settlement failed.", code: 7e3 }, WC_METHOD_UNSUPPORTED: { message: "Unsupported wc_ method.", code: 10001 } };
var Pt2 = { NOT_INITIALIZED: { message: "Not initialized.", code: 1 }, NO_MATCHING_KEY: { message: "No matching key.", code: 2 }, RESTORE_WILL_OVERRIDE: { message: "Restore will override.", code: 3 }, RESUBSCRIBED: { message: "Resubscribed.", code: 4 }, MISSING_OR_INVALID: { message: "Missing or invalid.", code: 5 }, EXPIRED: { message: "Expired.", code: 6 }, UNKNOWN_TYPE: { message: "Unknown type.", code: 7 }, MISMATCHED_TOPIC: { message: "Mismatched topic.", code: 8 }, NON_CONFORMING_NAMESPACES: { message: "Non conforming namespaces.", code: 9 } };
function N3(e, n3) {
  const { message: t, code: r } = Pt2[e];
  return { message: n3 ? `${t} ${n3}` : t, code: r };
}
function R2(e, n3) {
  const { message: t, code: r } = It3[e];
  return { message: n3 ? `${t} ${n3}` : t, code: r };
}
function C3(e, n3) {
  return Array.isArray(e) ? typeof n3 < "u" && e.length ? e.every(n3) : true : false;
...
function m3(e, n3) {
  return n3 && S2(e) ? true : typeof e == "string" && Boolean(e.trim().length);
}
function Rt3(e) {
  if (m3(e, false))
    try {
...
function Ni2(r, e) {
  ...
  function D3(u5) {
    ...
    if (u5.length === 0)
      return "";
    for (var y4 = 0, A3 = 0, v = 0, R6 = u5.length; v !== R6 && u5[v] === 0; )
      v++, y4++;
    for (var S8 = (R6 - v) * l2 + 1 >>> 0, m7 = new Uint8Array(S8); v !== R6; ) {
      for (var T4 = u5[v], O4 = 0, I3 = S8 - 1; (T4 !== 0 || O4 < A3) && I3 !== -1; I3--, O4++)
        T4 += 256 * m7[I3] >>> 0, m7[I3] = T4 % o2 >>> 0, T4 = T4 / o2 >>> 0;
      if (T4 !== 0)
        throw new Error("Non-zero carry");
      A3 = O4, v++;
    }
    for (var P4 = S8 - A3; P4 !== S8 && m7[P4] === 0; )
      P4++;
    for (var K4 = h3.repeat(y4); P4 < S8; ++P4)
      K4 += r.charAt(m7[P4]);
    return K4;
  }
  function b5(u5) {
    ...
    if (u5[y4] !== " ") {
      for (var A3 = 0, v = 0; u5[y4] === h3; )
        A3++, y4++;
      for (var R6 = (u5.length - y4) * d5 + 1 >>> 0, S8 = new Uint8Array(R6); u5[y4]; ) {
        var m7 = t[u5.charCodeAt(y4)];
        if (m7 === 255)
          return;
        for (var T4 = 0, O4 = R6 - 1; (m7 !== 0 || T4 < v) && O4 !== -1; O4--, T4++)
          m7 += o2 * S8[O4] >>> 0, S8[O4] = m7 % 256 >>> 0, m7 = m7 / 256 >>> 0;
        if (m7 !== 0)
          throw new Error("Non-zero carry");
        v = T4, y4++;
      }
      if (u5[y4] !== " ") {
        for (var I3 = R6 - v; I3 !== R6 && S8[I3] === 0; )
          I3++;
        for (var P4 = new Uint8Array(A3 + (R6 - I3)), K4 = A3; I3 !== R6; )
          P4[K4++] = S8[I3++];
        return P4;
      }
    }
  ...
  return { encode: D3, decodeUnsafe: b5, decode: H4 };
}
var Ui2 = Ni2;
var Li2 = Ui2;
var Pe4 = (r) => {
...
var Fi2 = (r) => new TextEncoder().encode(r);
var $i2 = (r) => new TextDecoder().decode(r);
var Mi2 = class {
  constructor(e, t, i4) {
    this.name = e, this.prefix = t, this.baseEncode = i4;
  }
...
var xe4 = (r, e) => new ki2({ ...r.decoders || { [r.prefix]: r }, ...e.decoders || { [e.prefix]: e } });
var Bi2 = class {
  constructor(e, t, i4, s) {
    this.name = e, this.prefix = t, this.baseEncode = i4, this.baseDecode = s, this.encoder = new Mi2(e, t, i4), this.decoder = new Ki2(e, t, s);
  }
  encode(e) {
    return this.encoder.encode(e);
  }
...
var q4 = ({ name: r, prefix: e, encode: t, decode: i4 }) => new Bi2(r, e, t, i4);
var $4 = ({ prefix: r, name: e, alphabet: t }) => {
  const { encode: i4, decode: s } = Li2(t, e);
  return q4({ prefix: r, name: e, encode: i4, decode: (n3) => Pe4(s(n3)) });
};
var ji2 = (r, e, t, i4) => {
  const s = {};
  for (let l2 = 0; l2 < e.length; ++l2)
...
var p4 = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i4 }) => q4({ prefix: e, name: r, encode(s) {
  return Vi2(s, i4, t);
}, decode(s) {
  return ji2(s, i4, t, r);
} });
var qi2 = q4({ prefix: "\0", name: "identity", encode: (r) => $i2(r), decode: (r) => Fi2(r) });
var Gi2 = Object.freeze({ __proto__: null, identity: qi2 });
var Yi2 = p4({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var Ji2 = Object.freeze({ __proto__: null, base2: Yi2 });
var Hi2 = p4({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
var Xi2 = Object.freeze({ __proto__: null, base8: Hi2 });
var Wi2 = $4({ prefix: "9", name: "base10", alphabet: "0123456789" });
var Zi2 = Object.freeze({ __proto__: null, base10: Wi2 });
var Qi2 = p4({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 });
var es2 = p4({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var ts2 = Object.freeze({ __proto__: null, base16: Qi2, base16upper: es2 });
var is2 = p4({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
var ss2 = p4({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 });
var rs2 = p4({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
var ns2 = p4({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 });
var as2 = p4({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 });
var os2 = p4({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 });
var hs2 = p4({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 });
var cs2 = p4({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 });
var us2 = p4({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
var ls2 = Object.freeze({ __proto__: null, base32: is2, base32upper: ss2, base32pad: rs2, base32padupper: ns2, base32hex: as2, base32hexupper: os2, base32hexpad: hs2, base32hexpadupper: cs2, base32z: us2 });
var ds2 = $4({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" });
var gs2 = $4({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
var ps2 = Object.freeze({ __proto__: null, base36: ds2, base36upper: gs2 });
var Ds2 = $4({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" });
var ys2 = $4({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var bs2 = Object.freeze({ __proto__: null, base58btc: Ds2, base58flickr: ys2 });
var ms2 = p4({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var fs2 = p4({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var Es2 = p4({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
var ws2 = p4({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
var vs2 = Object.freeze({ __proto__: null, base64: ms2, base64pad: fs2, base64url: Es2, base64urlpad: ws2 });
var Oe4 = Array.from("\u{1F680}\u{1FA90}\u2604\u{1F6F0}\u{1F30C}\u{1F311}\u{1F312}\u{1F313}\u{1F314}\u{1F315}\u{1F316}\u{1F317}\u{1F318}\u{1F30D}\u{1F30F}\u{1F30E}\u{1F409}\u2600\u{1F4BB}\u{1F5A5}\u{1F4BE}\u{1F4BF}\u{1F602}\u2764\u{1F60D}\u{1F923}\u{1F60A}\u{1F64F}\u{1F495}\u{1F62D}\u{1F618}\u{1F44D}\u{1F605}\u{1F44F}\u{1F601}\u{1F525}\u{1F970}\u{1F494}\u{1F496}\u{1F499}\u{1F622}\u{1F914}\u{1F606}\u{1F644}\u{1F4AA}\u{1F609}\u263A\u{1F44C}\u{1F917}\u{1F49C}\u{1F614}\u{1F60E}\u{1F607}\u{1F339}\u{1F926}\u{1F389}\u{1F49E}\u270C\u2728\u{1F937}\u{1F631}\u{1F60C}\u{1F338}\u{1F64C}\u{1F60B}\u{1F497}\u{1F49A}\u{1F60F}\u{1F49B}\u{1F642}\u{1F493}\u{1F929}\u{1F604}\u{1F600}\u{1F5A4}\u{1F603}\u{1F4AF}\u{1F648}\u{1F447}\u{1F3B6}\u{1F612}\u{1F92D}\u2763\u{1F61C}\u{1F48B}\u{1F440}\u{1F62A}\u{1F611}\u{1F4A5}\u{1F64B}\u{1F61E}\u{1F629}\u{1F621}\u{1F92A}\u{1F44A}\u{1F973}\u{1F625}\u{1F924}\u{1F449}\u{1F483}\u{1F633}\u270B\u{1F61A}\u{1F61D}\u{1F634}\u{1F31F}\u{1F62C}\u{1F643}\u{1F340}\u{1F337}\u{1F63B}\u{1F613}\u2B50\u2705\u{1F97A}\u{1F308}\u{1F608}\u{1F918}\u{1F4A6}\u2714\u{1F623}\u{1F3C3}\u{1F490}\u2639\u{1F38A}\u{1F498}\u{1F620}\u261D\u{1F615}\u{1F33A}\u{1F382}\u{1F33B}\u{1F610}\u{1F595}\u{1F49D}\u{1F64A}\u{1F639}\u{1F5E3}\u{1F4AB}\u{1F480}\u{1F451}\u{1F3B5}\u{1F91E}\u{1F61B}\u{1F534}\u{1F624}\u{1F33C}\u{1F62B}\u26BD\u{1F919}\u2615\u{1F3C6}\u{1F92B}\u{1F448}\u{1F62E}\u{1F646}\u{1F37B}\u{1F343}\u{1F436}\u{1F481}\u{1F632}\u{1F33F}\u{1F9E1}\u{1F381}\u26A1\u{1F31E}\u{1F388}\u274C\u270A\u{1F44B}\u{1F630}\u{1F928}\u{1F636}\u{1F91D}\u{1F6B6}\u{1F4B0}\u{1F353}\u{1F4A2}\u{1F91F}\u{1F641}\u{1F6A8}\u{1F4A8}\u{1F92C}\u2708\u{1F380}\u{1F37A}\u{1F913}\u{1F619}\u{1F49F}\u{1F331}\u{1F616}\u{1F476}\u{1F974}\u25B6\u27A1\u2753\u{1F48E}\u{1F4B8}\u2B07\u{1F628}\u{1F31A}\u{1F98B}\u{1F637}\u{1F57A}\u26A0\u{1F645}\u{1F61F}\u{1F635}\u{1F44E}\u{1F932}\u{1F920}\u{1F927}\u{1F4CC}\u{1F535}\u{1F485}\u{1F9D0}\u{1F43E}\u{1F352}\u{1F617}\u{1F911}\u{1F30A}\u{1F92F}\u{1F437}\u260E\u{1F4A7}\u{1F62F}\u{1F486}\u{1F446}\u{1F3A4}\u{1F647}\u{1F351}\u2744\u{1F334}\u{1F4A3}\u{1F438}\u{1F48C}\u{1F4CD}\u{1F940}\u{1F922}\u{1F445}\u{1F4A1}\u{1F4A9}\u{1F450}\u{1F4F8}\u{1F47B}\u{1F910}\u{1F92E}\u{1F3BC}\u{1F975}\u{1F6A9}\u{1F34E}\u{1F34A}\u{1F47C}\u{1F48D}\u{1F4E3}\u{1F942}");
var Is2 = Oe4.reduce((r, e, t) => (r[t] = e, r), []);
var Cs2 = Oe4.reduce((r, e, t) => (r[e.codePointAt(0)] = t, r), []);
function _s2(r) {
  return r.reduce((e, t) => (e += Is2[t], e), "");
}
function Rs2(r) {
  const e = [];
  for (const t of r) {
    const i4 = Cs2[t.codePointAt(0)];
    if (i4 === void 0)
      throw new Error(`Non-base256emoji character: ${t}`);
    e.push(i4);
  }
...
var Ss2 = q4({ prefix: "\u{1F680}", name: "base256emoji", encode: _s2, decode: Rs2 });
var Ts2 = Object.freeze({ __proto__: null, base256emoji: Ss2 });
var Ps2 = ze4;
var Ae4 = 128;
var xs2 = 127;
var Os2 = ~xs2;
var As2 = Math.pow(2, 31);
function ze4(r, e, t) {
  e = e || [], t = t || 0;
  for (var i4 = t; r >= As2; )
    e[t++] = r & 255 | Ae4, r /= 128;
  for (; r & Os2; )
    e[t++] = r & 255 | Ae4, r >>>= 7;
  return e[t] = r | 0, ze4.bytes = t - i4 + 1, e;
}
var zs2 = ne4;
var Ns2 = 128;
var Ne2 = 127;
function ne4(r, i4) {
  ...
  do {
    if (n3 >= o2)
      throw ne4.bytes = 0, new RangeError("Could not decode varint");
    a3 = r[n3++], t += s < 28 ? (a3 & Ne2) << s : (a3 & Ne2) * Math.pow(2, s), s += 7;
  } while (a3 >= Ns2);
  return ne4.bytes = n3 - i4, t;
}
var Us2 = Math.pow(2, 7);
var Ls2 = Math.pow(2, 14);
var Fs2 = Math.pow(2, 21);
var $s2 = Math.pow(2, 28);
var Ms2 = Math.pow(2, 35);
var Ks2 = Math.pow(2, 42);
var ks2 = Math.pow(2, 49);
var Bs2 = Math.pow(2, 56);
var js2 = Math.pow(2, 63);
var Vs2 = function(r) {
  return r < Us2 ? 1 : r < Ls2 ? 2 : r < Fs2 ? 3 : r < $s2 ? 4 : r < Ms2 ? 5 : r < Ks2 ? 6 : r < ks2 ? 7 : r < Bs2 ? 8 : r < js2 ? 9 : 10;
};
var qs2 = { encode: Ps2, decode: zs2, encodingLength: Vs2 };
var Ue4 = qs2;
var Le2 = (r, e, t = 0) => (Ue4.encode(r, e, t), e);
var Fe4 = (r) => Ue4.encodingLength(r);
var ae4 = (r, e) => {
  const t = e.byteLength, i4 = Fe4(r), s = i4 + Fe4(t), n3 = new Uint8Array(s + t);
  return Le2(r, n3, 0), Le2(t, n3, i4), n3.set(e, s), new Gs2(r, t, e, n3);
};
var Gs2 = class {
  constructor(e, t, i4, s) {
    this.code = e, this.size = t, this.digest = i4, this.bytes = s;
...
var $e4 = ({ name: r, code: e, encode: t }) => new Ys2(r, e, t);
var Ys2 = class {
  constructor(e, t, i4) {
    this.name = e, this.code = t, this.encode = i4;
  }
  digest(e) {
    if (e instanceof Uint8Array) {
      const t = this.encode(e);
      return t instanceof Uint8Array ? ae4(this.code, t) : t.then((i4) => ae4(this.code, i4));
    } else
      throw Error("Unknown type, must be binary type");
  }
};
var Me4 = (r) => async (e) => new Uint8Array(await crypto.subtle.digest(r, e));
var Js2 = $e4({ name: "sha2-256", code: 18, encode: Me4("SHA-256") });
var Hs2 = $e4({ name: "sha2-512", code: 19, encode: Me4("SHA-512") });
var Xs2 = Object.freeze({ __proto__: null, sha256: Js2, sha512: Hs2 });
var Ke2 = 0;
var Ws2 = "identity";
var ke2 = Pe4;
var Zs2 = (r) => ae4(Ke2, ke2(r));
var Qs2 = { code: Ke2, name: Ws2, encode: ke2, digest: Zs2 };
var er2 = Object.freeze({ __proto__: null, identity: Qs2 });
new TextEncoder(), new TextDecoder();
var Be3 = { ...Gi2, ...Ji2, ...Xi2, ...Zi2, ...ts2, ...ls2, ...ps2, ...bs2, ...vs2, ...Ts2 };
({ ...Xs2, ...er2 });
function je4(r) {
  return globalThis.Buffer != null ? new Uint8Array(r.buffer, r.byteOffset, r.byteLength) : r;
}
...
function Ve4(r, e, t, i4) {
  return { name: r, prefix: e, encoder: { name: r, prefix: e, encode: t }, decoder: { decode: i4 } };
}
var qe4 = Ve4("utf8", "u", (r) => "u" + new TextDecoder("utf8").decode(r), (r) => new TextEncoder().encode(r.substring(1)));
var oe2 = Ve4("ascii", "a", (r) => {
  let e = "a";
  for (let t = 0; t < r.length; t++)
    e += String.fromCharCode(r[t]);
  return e;
  ...
  r = r.substring(1);
  const e = tr2(r.length);
  for (let t = 0; t < r.length; t++)
    e[t] = r.charCodeAt(t);
  return e;
});
var ir = { utf8: qe4, "utf-8": qe4, hex: Be3.base16, latin1: oe2, ascii: oe2, binary: oe2, ...Be3 };
...
var G4 = "core";
var x = `${he2}@${2}:${G4}:`;
var Ye2 = { name: G4, logger: "error" };
var Je2 = { database: ":memory:" };
var He4 = "crypto";
var ce4 = "client_ed25519_seed";
var Xe2 = import_time4.ONE_DAY;
var We2 = "keychain";
var Ze2 = "0.3";
var Qe2 = "messages";
var et4 = "0.3";
var tt4 = import_time4.SIX_HOURS;
var it4 = "publisher";
var st4 = "irn";
var rt4 = "error";
var ue4 = "wss://relay.walletconnect.com";
var nt4 = "relayer";
...
var ot4 = import_time4.ONE_SECOND / 2;
var ht2 = "y";
var ct4 = 1e4;
var ut4 = "0.3";
...
var lt4 = "subscription";
var dt4 = "0.3";
var gt2 = import_time4.FIVE_SECONDS * 1e3;
var pt4 = "pairing";
var Dt2 = "0.3";
var L = { wc_pairingDelete: { req: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1e3 }, res: { ttl: import_time4.ONE_DAY, prompt: false, tag: 1001 } }, wc_pairingPing: { req: { ttl: import_time4.THIRTY_SECONDS, prompt: false, tag: 1002 }, res: { ttl: import_time4.THIRTY_SECONDS, prompt: false, tag: 1003 } }, unregistered_method: { req: { ttl: import_time4.ONE_DAY, prompt: false, tag: 0 }, res: { ttl: import_time4.ONE_DAY, prompt: false, tag: 0 } } };
...
var ft4 = "0.3";
var Y4 = "verify-api";
var le4 = "https://verify.walletconnect.com";
var Et2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.keychain = /* @__PURE__ */ new Map(), this.name = We2, this.version = Ze2, this.initialized = false, this.storagePrefix = x, this.init = async () => {
      if (!this.initialized) {
        const i4 = await this.getKeyChain();
        typeof i4 < "u" && (this.keychain = i4), this.initialized = true;
      }
      ...
      const s = this.keychain.get(i4);
      if (typeof s > "u") {
        const { message: n3 } = N3("NO_MATCHING_KEY", `${this.name}: ${i4}`);
        throw new Error(n3);
      }
      return s;
    }, this.del = async (i4) => {
...
var wt2 = class {
  constructor(e, t, i4) {
    this.core = e, this.logger = t, this.name = He4, this.initialized = false, this.init = async () => {
      this.initialized || (await this.keychain.init(), this.initialized = true);
    }, this.hasKeys = (s) => (this.isInitialized(), this.keychain.has(s)), this.getClientId = async () => {
      this.isInitialized();
      const s = await this.getClientSeed(), n3 = generateKeyPair(s);
      ...
      this.isInitialized();
      const n3 = await this.getClientSeed(), a3 = generateKeyPair(n3), o2 = Un2(), h3 = Xe2;
      return await signJWT(o2, s, h3, a3);
    }, this.generateSharedKey = (s, n3, a3) => {
      this.isInitialized();
      const o2 = this.getPrivateKey(s), h3 = _n2(o2, n3);
      return this.setSymKey(h3, a3);
    }, this.setSymKey = async (s, n3) => {
      this.isInitialized();
      const a3 = n3 || wn2(s);
      ...
      if (Vn2(o2)) {
        const b5 = o2.senderPublicKey, H4 = o2.receiverPublicKey;
        s = await this.generateSharedKey(b5, H4);
      }
      const d5 = this.getSymKey(s), { type: l2, senderPublicKey: D3 } = o2;
      return Cn2({ type: l2, symKey: d5, message: h3, senderPublicKey: D3 });
    }, this.decode = async (s, n3, a3) => {
      this.isInitialized();
      const o2 = Dn2(n3, a3);
      if (Vn2(o2)) {
      ...
      const h3 = this.getSymKey(s), d5 = $n2({ symKey: h3, encoded: n3 });
      return safeJsonParse(d5);
    }, this.getPayloadType = (s) => {
      const n3 = Q2(s);
      return j2(n3.type);
    ...
    }, this.core = e, this.logger = (0, import_logger2.generateChildLogger)(t, this.name), this.keychain = i4 || new Et2(this.core, this.logger);
  }
  get context() {
    return (0, import_logger2.getLoggerContext)(this.logger);
  }
  ...
  async getClientSeed() {
    let e = "";
    try {
      e = this.keychain.get(ce4);
    } catch {
      e = Un2(), await this.keychain.set(ce4, e);
    }
    return sr(e, "base16");
  }
  getSymKey(e) {
...
var vt2 = class extends a2 {
  constructor(e, t) {
    super(e, t), this.logger = e, this.core = t, this.messages = /* @__PURE__ */ new Map(), this.name = Qe2, this.version = et4, this.initialized = false, this.storagePrefix = x, this.init = async () => {
      if (!this.initialized) {
        this.logger.trace("Initialized");
        try {
          const i4 = await this.getRelayerMessages();
...
var hr2 = class extends u2 {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events7.EventEmitter(), this.name = it4, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = 1e4, this.publish = async (i4, s, n3) => {
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i4, message: s, opts: n3 } });
      try {
        const a3 = (n3 == null ? void 0 : n3.ttl) || tt4, o2 = ct3(n3), h3 = (n3 == null ? void 0 : n3.prompt) || false, d5 = (n3 == null ? void 0 : n3.tag) || 0, l2 = (n3 == null ? void 0 : n3.id) || getBigIntRpcId().toString(), D3 = { topic: i4, message: s, opts: { ttl: a3, relay: o2, prompt: h3, tag: d5, id: l2 } };
        this.queue.set(l2, D3);
        try {
          await await et3(this.rpcPublish(i4, s, a3, o2, h3, d5, l2), this.publishTimeout), this.relayer.events.emit(g3.publish, D3);
        } catch {
          this.logger.debug("Publishing Payload stalled"), this.relayer.events.emit(g3.connection_stalled);
          return;
        }
        this.logger.debug("Successfully Published Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i4, message: s, opts: n3 } });
      } catch (a3) {
        throw this.logger.debug("Failed to Publish Payload"), this.logger.error(a3), a3;
      }
    }, this.on = (i4, s) => {
  ...
  rpcPublish(e, t, i4, s, n3, a3, o2) {
    var h3, d5, l2, D3;
    const b5 = { method: at3(s.protocol).publish, params: { topic: e, message: t, ttl: i4, prompt: n3, tag: a3 }, id: o2 };
    return S2((h3 = b5.params) == null ? void 0 : h3.prompt) && ((d5 = b5.params) == null || delete d5.prompt), S2((l2 = b5.params) == null ? void 0 : l2.tag) && ((D3 = b5.params) == null || delete D3.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: b5 }), this.relayer.request(b5);
  }
  onPublish(e) {
    this.queue.delete(e);
  }
...
var lr2 = Object.defineProperties;
...
var Ct3 = (r, e, t) => e in r ? ur2(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var M2 = (r, e) => {
  for (var t in e || (e = {}))
    gr2.call(e, t) && Ct3(r, t, e[t]);
  if (It4)
    for (var t of It4(e))
      pr2.call(e, t) && Ct3(r, t, e[t]);
  return r;
};
var de2 = (r, e) => lr2(r, dr2(e));
var _t2 = class extends d2 {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new cr2(), this.events = new import_events7.EventEmitter(), this.name = lt4, this.version = dt4, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = x, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restart(), this.registerEventListeners(), this.onEnable(), this.clientId = await this.relayer.core.crypto.getClientId());
    }, this.subscribe = async (i4, s) => {
      await this.restartToComplete(), this.isInitialized(), this.logger.debug("Subscribing Topic"), this.logger.trace({ type: "method", method: "subscribe", params: { topic: i4, opts: s } });
      try {
        const n3 = ct3(s), a3 = { topic: i4, relay: n3 };
        this.pending.set(i4, a3);
        const o2 = await this.rpcSubscribe(i4, n3);
        return this.onSubscribe(o2, a3), this.logger.debug("Successfully Subscribed Topic"), this.logger.trace({ type: "method", method: "subscribe", params: { topic: i4, opts: s } }), o2;
      } catch (n3) {
      ...
      a3.start(this.pendingSubscriptionWatchLabel);
      const o2 = setInterval(() => {
        !this.pending.has(i4) && this.topics.includes(i4) && (clearInterval(o2), a3.stop(this.pendingSubscriptionWatchLabel), s(true)), a3.elapsed(this.pendingSubscriptionWatchLabel) >= gt2 && (clearInterval(o2), a3.stop(this.pendingSubscriptionWatchLabel), n3(new Error("Subscription resolution timeout")));
      }, this.pollingInterval);
    }).catch(() => false), this.on = (i4, s) => {
      this.events.on(i4, s);
    }, this.once = (i4, s) => {
      this.events.once(i4, s);
    }, this.off = (i4, s) => {
  ...
  async unsubscribeById(e, t, i4) {
    ...
    try {
      const s = ct3(i4);
      await this.rpcUnsubscribe(e, t, s);
      const n3 = R2("USER_DISCONNECTED", `${this.name}, ${e}`);
      await this.onUnsubscribe(e, t, n3), this.logger.debug("Successfully Unsubscribed Topic"), this.logger.trace({ type: "method", method: "unsubscribe", params: { topic: e, id: t, opts: i4 } });
    } catch (s) {
      throw this.logger.debug("Failed to Unsubscribe Topic"), this.logger.error(s), s;
    }
  ...
  async rpcSubscribe(e, t) {
    const i4 = { method: at3(t.protocol).subscribe, params: { topic: e } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i4 });
    try {
      await await et3(this.relayer.request(i4), this.subscribeTimeout);
    } catch {
      this.logger.debug("Outgoing Relay Subscribe Payload stalled"), this.relayer.events.emit(g3.connection_stalled);
    }
    return jn2(e + this.clientId);
  }
  async rpcBatchSubscribe(e) {
    if (!e.length)
      return;
    const t = e[0].relay, i4 = { method: at3(t.protocol).batchSubscribe, params: { topics: e.map((s) => s.topic) } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i4 });
    try {
      return await await et3(this.relayer.request(i4), this.subscribeTimeout);
    } catch {
      this.logger.debug("Outgoing Relay Payload stalled"), this.relayer.events.emit(g3.connection_stalled);
    }
  }
  rpcUnsubscribe(e, t, i4) {
    const s = { method: at3(i4.protocol).unsubscribe, params: { topic: e, id: t } };
    return this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: s }), this.relayer.request(s);
  }
  onSubscribe(e, t) {
    this.setSubscription(e, de2(M2({}, t), { id: e })), this.pending.delete(t.topic);
  }
  onBatchSubscribe(e) {
    e.length && e.forEach((t) => {
      this.setSubscription(t.id, M2({}, t)), this.pending.delete(t.topic);
    });
  }
  async onUnsubscribe(e, t, i4) {
    this.events.removeAllListeners(t), this.hasSubscription(t, e) && this.deleteSubscription(t, i4), await this.relayer.messages.del(e);
  ...
  addSubscription(e, t) {
    this.subscriptions.set(e, M2({}, t)), this.topicMap.set(t.topic, e), this.events.emit(C4.created, t);
  }
  getSubscription(e) {
    this.logger.debug("Getting subscription"), this.logger.trace({ type: "method", method: "getSubscription", id: e });
    const t = this.subscriptions.get(e);
    if (!t) {
      const { message: i4 } = N3("NO_MATCHING_KEY", `${this.name}: ${e}`);
      throw new Error(i4);
    }
    return t;
  }
  deleteSubscription(e, t) {
    this.logger.debug("Deleting subscription"), this.logger.trace({ type: "method", method: "deleteSubscription", id: e, reason: t });
    const i4 = this.getSubscription(e);
    this.subscriptions.delete(e), this.topicMap.delete(i4.topic, e), this.events.emit(C4.deleted, de2(M2({}, i4), { reason: t }));
  }
  async persist() {
  ...
  async batchSubscribe(e) {
    if (!e.length)
      return;
    const t = await this.rpcBatchSubscribe(e);
    C3(t) && this.onBatchSubscribe(t.map((i4, s) => de2(M2({}, e[s]), { id: i4 })));
  }
  async onConnect() {
    this.restartInProgress || (await this.restart(), this.onEnable());
  }
...
var Dr2 = Object.defineProperty;
var Rt4 = Object.getOwnPropertySymbols;
var yr2 = Object.prototype.hasOwnProperty;
var br2 = Object.prototype.propertyIsEnumerable;
var St3 = (r, e, t) => e in r ? Dr2(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var mr2 = (r, e) => {
  for (var t in e || (e = {}))
    yr2.call(e, t) && St3(r, t, e[t]);
  if (Rt4)
    for (var t of Rt4(e))
      br2.call(e, t) && St3(r, t, e[t]);
  return r;
};
var Tt3 = class extends g2 {
  constructor(e) {
    super(e), this.protocol = "wc", this.version = 2, this.events = new import_events7.EventEmitter(), this.name = nt4, this.transportExplicitlyClosed = false, this.initialized = false, this.reconnecting = false, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.request = async (t) => {
      this.logger.debug("Publishing Request Payload");
      try {
        return await this.toEstablishConnection(), await this.provider.request(t);
      } catch (i4) {
    ...
    }, this.core = e.core, this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? (0, import_logger2.generateChildLogger)(e.logger, this.name) : (0, import_logger2.pino)((0, import_logger2.getDefaultLoggerOptions)({ level: e.logger || rt4 })), this.messages = new vt2(this.logger, e.core), this.subscriber = new _t2(this, this.logger), this.publisher = new hr2(this, this.logger), this.relayUrl = (e == null ? void 0 : e.relayUrl) || ue4, this.projectId = e.projectId, this.provider = {};
  }
  async init() {
  ...
  async subscribe(e, t) {
    ...
    let i4 = "";
    return await Promise.all([new Promise((s) => {
      this.subscriber.once(C4.created, (n3) => {
        n3.topic === e && s();
      });
    }), new Promise(async (s) => {
      i4 = await this.subscriber.subscribe(e, t), s();
    ...
    if (this.transportExplicitlyClosed = false, !this.reconnecting) {
      ...
      try {
        await Promise.all([new Promise((t) => {
          ...
          await et3(this.provider.connect(), 5e3, "socket stalled").catch((s) => i4(s)).then(() => t()).finally(() => this.removeListener(g3.transport_closed, this.rejectTransportOpen));
  ...
  async createProvider() {
    const e = await this.core.crypto.signJWT(this.relayUrl);
    this.provider = new JsonRpcProvider(new esm_default(qn({ sdkVersion: ht2, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: e, useOnCloseEvent: true }))), this.registerProviderListeners();
  }
  async recordMessageEvent(e) {
    const { topic: t, message: i4 } = e;
    await this.messages.set(t, i4);
  ...
  async onProviderPayload(e) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e }), isJsonRpcRequest(e)) {
      if (!e.method.endsWith(at4))
        return;
      const t = e.params, { topic: i4, message: s, publishedAt: n3 } = t.data, a3 = { topic: i4, message: s, publishedAt: n3 };
      this.logger.debug("Emitting Relayer Payload"), this.logger.trace(mr2({ type: "event", event: t.id }, a3)), this.events.emit(t.id, a3), await this.acknowledgePayload(e), await this.onMessageEvent(a3);
    } else
  ...
  attemptToReconnect() {
    this.transportExplicitlyClosed || setTimeout(async () => {
      await this.restartTransport();
    }, (0, import_time4.toMiliseconds)(ot4));
  }
  isInitialized() {
    if (!this.initialized) {
      const { message: e } = N3("NOT_INITIALIZED", this.name);
...
var fr2 = Object.defineProperty;
var Pt3 = Object.getOwnPropertySymbols;
var Er2 = Object.prototype.hasOwnProperty;
var wr2 = Object.prototype.propertyIsEnumerable;
var xt2 = (r, e, t) => e in r ? fr2(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var Ot2 = (r, e) => {
  for (var t in e || (e = {}))
    Er2.call(e, t) && xt2(r, t, e[t]);
  if (Pt3)
    for (var t of Pt3(e))
      wr2.call(e, t) && xt2(r, t, e[t]);
  return r;
};
var At4 = class extends p3 {
  constructor(e, t, i4, s = x, n3 = void 0) {
    super(e, t, i4, s), this.core = e, this.logger = t, this.name = i4, this.map = /* @__PURE__ */ new Map(), this.version = ut4, this.cached = [], this.initialized = false, this.storagePrefix = x, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((a3) => {
        this.getKey && a3 !== null && !S2(a3) ? this.map.set(this.getKey(a3), a3) : At3(a3) ? this.map.set(a3.id, a3) : Ut2(a3) && this.map.set(a3.topic, a3);
      }), this.cached = [], this.initialized = true);
    }, this.set = async (a3, o2) => {
      this.isInitialized(), this.map.has(a3) ? await this.update(a3, o2) : (this.logger.debug("Setting value"), this.logger.trace({ type: "method", method: "set", key: a3, value: o2 }), this.map.set(a3, o2), await this.persist());
      ...
      this.isInitialized(), this.logger.debug("Updating value"), this.logger.trace({ type: "method", method: "update", key: a3, update: o2 });
      const h3 = Ot2(Ot2({}, this.getData(a3)), o2);
      this.map.set(a3, h3), await this.persist();
    }, this.delete = async (a3, o2) => {
      this.isInitialized(), this.map.has(a3) && (this.logger.debug("Deleting value"), this.logger.trace({ type: "method", method: "delete", key: a3, reason: o2 }), this.map.delete(a3), await this.persist());
    }, this.logger = (0, import_logger2.generateChildLogger)(t, this.name), this.storagePrefix = s, this.getKey = n3;
  }
  get context() {
    return (0, import_logger2.getLoggerContext)(this.logger);
  }
...
var zt2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = pt4, this.version = Dt2, this.events = new import_events7.default(), this.initialized = false, this.storagePrefix = x, this.ignoredPayloadTypes = [U3], this.registeredMethods = [], this.init = async () => {
      this.initialized || (await this.pairings.init(), await this.cleanup(), this.registerRelayerEvents(), this.registerExpirerEvents(), this.initialized = true, this.logger.trace("Initialized"));
    }, this.register = ({ methods: i4 }) => {
      this.isInitialized(), this.registeredMethods = [.../* @__PURE__ */ new Set([...this.registeredMethods, ...i4])];
    }, this.create = async () => {
      this.isInitialized();
      const i4 = Un2(), s = await this.core.crypto.setSymKey(i4), n3 = ot3(import_time4.FIVE_MINUTES), a3 = { protocol: st4 }, o2 = { topic: s, expiry: n3, relay: a3, active: false }, h3 = mt2({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i4, relay: a3 });
      return await this.pairings.set(s, o2), await this.core.relayer.subscribe(s), this.core.expirer.set(s, n3), { topic: s, uri: h3 };
    }, this.pair = async (i4) => {
      this.isInitialized(), this.isValidPair(i4);
      const { topic: s, symKey: n3, relay: a3 } = pt3(i4.uri);
      if (this.pairings.keys.includes(s))
        throw new Error(`Pairing already exists: ${s}`);
      if (this.core.crypto.hasKeys(s))
        throw new Error(`Keychain already exists: ${s}`);
      const o2 = ot3(import_time4.FIVE_MINUTES), h3 = { topic: s, relay: a3, expiry: o2, active: false };
      return await this.pairings.set(s, h3), await this.core.crypto.setSymKey(n3, s), await this.core.relayer.subscribe(s, { relay: a3 }), this.core.expirer.set(s, o2), i4.activatePairing && await this.activate({ topic: s }), h3;
    }, this.activate = async ({ topic: i4 }) => {
      this.isInitialized();
      const s = ot3(import_time4.THIRTY_DAYS);
      await this.pairings.update(i4, { active: true, expiry: s }), this.core.expirer.set(i4, s);
    }, this.ping = async (i4) => {
      this.isInitialized(), await this.isValidPing(i4);
      const { topic: s } = i4;
      if (this.pairings.keys.includes(s)) {
        ...
        this.events.once(it3("pairing_ping", n3), ({ error: d5 }) => {
          d5 ? h3(d5) : o2();
        }), await a3();
      }
    }, this.updateExpiry = async ({ topic: i4, expiry: s }) => {
      ...
      const a3 = formatJsonRpcRequest(s, n3), o2 = await this.core.crypto.encode(i4, a3), h3 = L[s].req;
      return this.core.history.set(i4, a3), this.core.relayer.publish(i4, o2, h3), a3.id;
    }, this.sendResult = async (i4, s, n3) => {
      const a3 = formatJsonRpcResult(i4, n3), o2 = await this.core.crypto.encode(s, a3), h3 = await this.core.history.get(s, i4), d5 = L[h3.request.method].res;
      await this.core.relayer.publish(s, o2, d5), await this.core.history.resolve(a3);
    }, this.sendError = async (i4, s, n3) => {
      const a3 = formatJsonRpcError(i4, n3), o2 = await this.core.crypto.encode(s, a3), h3 = await this.core.history.get(s, i4), d5 = L[h3.request.method] ? L[h3.request.method].res : L.unregistered_method.res;
      await this.core.relayer.publish(s, o2, d5), await this.core.history.resolve(a3);
    }, this.deletePairing = async (i4, s) => {
      await this.core.relayer.unsubscribe(i4), await Promise.all([this.pairings.delete(i4, R2("USER_DISCONNECTED")), this.core.crypto.deleteSymKey(i4), s ? Promise.resolve() : this.core.expirer.del(i4)]);
    }, this.cleanup = async () => {
      const i4 = this.pairings.getAll().filter((s) => st3(s.expiry));
      await Promise.all(i4.map((s) => this.deletePairing(s.topic)));
    }, this.onRelayEventRequest = (i4) => {
      const { topic: s, payload: n3 } = i4, a3 = n3.method;
      if (this.pairings.keys.includes(s))
      ...
      const { id: n3 } = s;
      setTimeout(() => {
        isJsonRpcResult(s) ? this.events.emit(it3("pairing_ping", n3), {}) : isJsonRpcError(s) && this.events.emit(it3("pairing_ping", n3), { error: s.error });
      }, 500);
    }, this.onPairingDeleteRequest = async (i4, s) => {
      const { id: n3 } = s;
      try {
      ...
      this.registeredMethods.includes(i4) || this.logger.error(R2("WC_METHOD_UNSUPPORTED", i4));
    }, this.isValidPair = (i4) => {
      if (!$t2(i4)) {
        const { message: s } = N3("MISSING_OR_INVALID", `pair() params: ${i4}`);
        throw new Error(s);
      }
      if (!Rt3(i4.uri)) {
        const { message: s } = N3("MISSING_OR_INVALID", `pair() uri: ${i4.uri}`);
        throw new Error(s);
      }
    }, this.isValidPing = async (i4) => {
      if (!$t2(i4)) {
        const { message: n3 } = N3("MISSING_OR_INVALID", `ping() params: ${i4}`);
        throw new Error(n3);
      }
      const { topic: s } = i4;
      await this.isValidPairingTopic(s);
      ...
      if (!$t2(i4)) {
        const { message: n3 } = N3("MISSING_OR_INVALID", `disconnect() params: ${i4}`);
        throw new Error(n3);
      }
      const { topic: s } = i4;
      await this.isValidPairingTopic(s);
      ...
      if (!m3(i4, false)) {
        const { message: s } = N3("MISSING_OR_INVALID", `pairing topic should be a string: ${i4}`);
        throw new Error(s);
      }
      if (!this.pairings.keys.includes(i4)) {
        const { message: s } = N3("NO_MATCHING_KEY", `pairing topic doesn't exist: ${i4}`);
        throw new Error(s);
      }
      if (st3(this.pairings.get(i4).expiry)) {
        await this.deletePairing(i4);
        const { message: s } = N3("EXPIRED", `pairing topic: ${i4}`);
        throw new Error(s);
      }
    }, this.core = e, this.logger = (0, import_logger2.generateChildLogger)(t, this.name), this.pairings = new At4(this.core, this.logger, this.name, this.storagePrefix);
  }
  get context() {
    return (0, import_logger2.getLoggerContext)(this.logger);
  }
  ...
  registerExpirerEvents() {
    this.core.expirer.on(w.expired, async (e) => {
      const { topic: t } = rt3(e.target);
      t && this.pairings.keys.includes(t) && (await this.deletePairing(t, true), this.events.emit("pairing_expire", { topic: t }));
    });
  }
};
var Nt2 = class extends h2 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events7.EventEmitter(), this.name = yt2, this.version = bt2, this.cached = [], this.initialized = false, this.storagePrefix = x, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((i4) => this.records.set(i4.id, i4)), this.cached = [], this.registerEventListeners(), this.initialized = true);
    }, this.set = (i4, s, n3) => {
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i4, request: s, chainId: n3 }), this.records.has(s.id))
        return;
      const a3 = { id: s.id, topic: i4, request: { method: s.method, params: s.params || null }, chainId: n3 };
      this.records.set(a3.id, a3), this.events.emit(_3.created, a3);
    }, this.resolve = async (i4) => {
      if (this.isInitialized(), this.logger.debug("Updating JSON-RPC response history record"), this.logger.trace({ type: "method", method: "update", response: i4 }), !this.records.has(i4.id))
        return;
      const s = await this.getRecord(i4.id);
      typeof s.response > "u" && (s.response = isJsonRpcError(i4) ? { error: i4.error } : { result: i4.result }, this.records.set(s.id, s), this.events.emit(_3.updated, s));
    }, this.get = async (i4, s) => (this.isInitialized(), this.logger.debug("Getting record"), this.logger.trace({ type: "method", method: "get", topic: i4, id: s }), await this.getRecord(s)), this.delete = (i4, s) => {
      this.isInitialized(), this.logger.debug("Deleting record"), this.logger.trace({ type: "method", method: "delete", id: s }), this.values.forEach((n3) => {
        if (n3.topic === i4) {
          if (typeof s < "u" && n3.id !== s)
...
var Ut3 = class extends E3 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events7.EventEmitter(), this.name = mt3, this.version = ft4, this.cached = [], this.initialized = false, this.storagePrefix = x, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((i4) => this.expirations.set(i4.target, i4)), this.cached = [], this.registerEventListeners(), this.initialized = true);
    }, this.has = (i4) => {
      try {
        const s = this.formatTarget(i4);
  ...
  checkExpiry(e, t) {
    const { expiry: i4 } = t;
    (0, import_time4.toMiliseconds)(i4) - Date.now() <= 0 && this.expire(e, t);
  }
  expire(e, t) {
  ...
  registerEventListeners() {
    this.core.heartbeat.on(import_heartbeat2.HEARTBEAT_EVENTS.pulse, () => this.checkExpirations()), this.events.on(w.created, (e) => {
      const t = w.created;
      this.logger.info(`Emitting ${t}`), this.logger.debug({ type: "event", event: t, data: e }), this.persist();
...
var Lt2 = class extends y2 {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = Y4, this.initialized = false, this.init = async (i4) => {
      je3() || !Ce2() || (this.verifyUrl = (i4 == null ? void 0 : i4.verifyUrl) || le4, await this.createIframe());
    }, this.register = async (i4) => {
      var s;
      this.initialized || await this.init(), this.iframe && ((s = this.iframe.contentWindow) == null || s.postMessage(i4.attestationId, this.verifyUrl), this.logger.info(`postMessage sent: ${i4.attestationId} ${this.verifyUrl}`));
    }, this.resolve = async (i4) => {
      ...
      if (this.isDevEnv)
        return "";
      this.logger.info(`resolving attestation: ${i4.attestationId}`);
      const n3 = this.startAbortTimer(import_time4.FIVE_SECONDS), a3 = await fetch(`${this.verifyUrl}/attestation/${i4.attestationId}`, { signal: this.abortController.signal });
      return clearTimeout(n3), a3.status === 200 ? (s = await a3.json()) == null ? void 0 : s.origin : "";
    }, this.createIframe = async () => {
      try {
        await Promise.race([new Promise((i4, s) => {
          if (document.getElementById(Y4))
            return i4();
          const n3 = document.createElement("iframe");
          n3.setAttribute("id", Y4), n3.setAttribute("src", `${this.verifyUrl}/${this.projectId}`), n3.style.display = "none", n3.addEventListener("load", () => {
            this.initialized = true, i4();
          }), n3.addEventListener("error", (a3) => {
            s(a3);
          }), document.body.append(n3), this.iframe = n3;
        }), new Promise((i4) => {
          setTimeout(() => i4("iframe load timeout"), (0, import_time4.toMiliseconds)(import_time4.ONE_SECOND / 2));
        })]);
      } catch (i4) {
        this.logger.error(`Verify iframe failed to load: ${this.verifyUrl}`), this.logger.error(i4);
      }
    }, this.logger = (0, import_logger2.generateChildLogger)(t, this.name), this.verifyUrl = le4, this.abortController = new AbortController(), this.isDevEnv = X2() && import_process.default.env.IS_VITEST;
  }
  get context() {
    return (0, import_logger2.getLoggerContext)(this.logger);
  }
...
var $t3 = (r, e, t) => e in r ? vr2(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var Mt2 = (r, e) => {
  for (var t in e || (e = {}))
    Ir2.call(e, t) && $t3(r, t, e[t]);
  if (Ft2)
    for (var t of Ft2(e))
      Cr.call(e, t) && $t3(r, t, e[t]);
  return r;
};
var J4 = class extends n2 {
  constructor(e) {
    super(e), this.protocol = he2, this.version = Ge2, this.name = G4, this.events = new import_events7.EventEmitter(), this.initialized = false, this.on = (i4, s) => this.events.on(i4, s), this.once = (i4, s) => this.events.once(i4, s), this.off = (i4, s) => this.events.off(i4, s), this.removeListener = (i4, s) => this.events.removeListener(i4, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || ue4;
    const t = typeof (e == null ? void 0 : e.logger) < "u" && typeof (e == null ? void 0 : e.logger) != "string" ? e.logger : (0, import_logger2.pino)((0, import_logger2.getDefaultLoggerOptions)({ level: (e == null ? void 0 : e.logger) || Ye2.logger }));
    this.logger = (0, import_logger2.generateChildLogger)(t, this.name), this.heartbeat = new import_heartbeat2.HeartBeat(), this.crypto = new wt2(this, this.logger, e == null ? void 0 : e.keychain), this.history = new Nt2(this, this.logger), this.expirer = new Ut3(this, this.logger), this.storage = e != null && e.storage ? e.storage : new import_keyvaluestorage2.default(Mt2(Mt2({}, Je2), e == null ? void 0 : e.storageOptions)), this.relayer = new Tt3({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new zt2(this, this.logger), this.verify = new Lt2(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new J4(e);
    return await t.initialize(), t;
...
var ue5 = __toESM(require_x25519());
init_es();
...
var U5 = 1;
function wn3(e) {
  const n3 = (0, import_sha2563.hash)(fromString(e, f5));
  return toString(n3, f5);
}
var Pt4 = { NOT_INITIALIZED: { message: "Not initialized.", code: 1 }, NO_MATCHING_KEY: { message: "No matching key.", code: 2 }, RESTORE_WILL_OVERRIDE: { message: "Restore will override.", code: 3 }, RESUBSCRIBED: { message: "Resubscribed.", code: 4 }, MISSING_OR_INVALID: { message: "Missing or invalid.", code: 5 }, EXPIRED: { message: "Expired.", code: 6 }, UNKNOWN_TYPE: { message: "Unknown type.", code: 7 }, MISMATCHED_TOPIC: { message: "Mismatched topic.", code: 8 }, NON_CONFORMING_NAMESPACES: { message: "Non conforming namespaces.", code: 9 } };
function N5(e, n3) {
...
function m4(e, n3) {
  return n3 && S3(e) ? true : typeof e == "string" && Boolean(e.trim().length);
}
function F(e, n3) {
  return n3 && S3(e) ? true : typeof e == "number" && !isNaN(e);
}
function Rt5(e) {
  if (m4(e, false))
    try {
...
var G5 = "https://rpc.walletconnect.com/v1";
var R3 = { wc_authRequest: { req: { ttl: import_time6.ONE_DAY, prompt: true, tag: 3e3 }, res: { ttl: import_time6.ONE_DAY, prompt: false, tag: 3001 } } };
...
async function Qe3(r, t, e, i4, n3) {
  switch (e.t) {
    case "eip191":
      return Ze3(r, t, e.s);
    case "eip1271":
      return await We3(r, t, e.s, i4, n3);
    default:
...
function tt5(r) {
  const t = Rt5(r.aud), e = new RegExp(`${r.domain}`).test(r.aud), i4 = !!r.nonce, n3 = r.type ? r.type === "eip4361" : true, s = r.expiry;
  if (s && !qt(s, U6)) {
    const { message: u5 } = N5("MISSING_OR_INVALID", `request() expiry: ${s}. Expiry must be a number (in seconds) between ${U6.min} and ${U6.max}`);
    throw new Error(u5);
  }
  return !!(t && e && i4 && n3);
}
...
function nt5(r, t) {
  ...
  function p6(c4) {
    ...
    if (c4.length === 0)
      return "";
    for (var f8 = 0, _5 = 0, b5 = 0, w4 = c4.length; b5 !== w4 && c4[b5] === 0; )
      b5++, f8++;
    for (var C7 = (w4 - b5) * D3 + 1 >>> 0, E6 = new Uint8Array(C7); b5 !== w4; ) {
      for (var m7 = c4[b5], A3 = 0, y4 = C7 - 1; (m7 !== 0 || A3 < _5) && y4 !== -1; y4--, A3++)
        m7 += 256 * E6[y4] >>> 0, E6[y4] = m7 % o2 >>> 0, m7 = m7 / o2 >>> 0;
      if (m7 !== 0)
        throw new Error("Non-zero carry");
      _5 = A3, b5++;
    }
    for (var v = C7 - _5; v !== C7 && E6[v] === 0; )
      v++;
    for (var I3 = a3.repeat(f8); v < C7; ++v)
      I3 += r.charAt(E6[v]);
    return I3;
  }
  function g5(c4) {
    ...
    var f8 = 0;
    if (c4[f8] !== " ") {
      for (var _5 = 0, b5 = 0; c4[f8] === a3; )
        _5++, f8++;
      for (var w4 = (c4.length - f8) * h3 + 1 >>> 0, C7 = new Uint8Array(w4); c4[f8]; ) {
        var E6 = e[c4.charCodeAt(f8)];
        if (E6 === 255)
          return;
        for (var m7 = 0, A3 = w4 - 1; (E6 !== 0 || m7 < b5) && A3 !== -1; A3--, m7++)
      ...
      if (c4[f8] !== " ") {
        for (var y4 = w4 - b5; y4 !== w4 && C7[y4] === 0; )
          y4++;
        for (var v = new Uint8Array(_5 + (w4 - y4)), I3 = _5; y4 !== w4; )
          v[I3++] = C7[y4++];
        return v;
      }
    }
...
var ot5 = (r) => new TextEncoder().encode(r);
var at5 = (r) => new TextDecoder().decode(r);
var Dt3 = class {
  constructor(t, e, i4) {
...
var te = (r, t) => new ht3({ ...r.decoders || { [r.prefix]: r }, ...t.decoders || { [t.prefix]: t } });
var lt5 = class {
  constructor(t, e, i4, n3) {
    this.name = t, this.prefix = e, this.baseEncode = i4, this.baseDecode = n3, this.encoder = new Dt3(t, e, i4), this.decoder = new ct5(t, e, n3);
  }
  encode(t) {
...
var S4 = ({ name: r, prefix: t, encode: e, decode: i4 }) => new lt5(r, t, e, i4);
var T = ({ prefix: r, name: t, alphabet: e }) => {
  const { encode: i4, decode: n3 } = ut5(e, t);
  return S4({ prefix: r, name: t, encode: i4, decode: (s) => ee3(n3(s)) });
};
var dt5 = (r, t, e, i4) => {
  const n3 = {};
...
var pt5 = (r, t, e) => {
  const i4 = t[t.length - 1] === "=", n3 = (1 << e) - 1;
  let s = "", u5 = 0, o2 = 0;
  for (let a3 = 0; a3 < r.length; ++a3)
    for (o2 = o2 << 8 | r[a3], u5 += 8; u5 > e; )
      u5 -= e, s += t[n3 & o2 >> u5];
  if (u5 && (s += t[n3 & o2 << e - u5]), i4)
    for (; s.length * e & 7; )
      s += "=";
  return s;
};
var d3 = ({ name: r, prefix: t, bitsPerChar: e, alphabet: i4 }) => S4({ prefix: t, name: r, encode(n3) {
  return pt5(n3, i4, e);
}, decode(n3) {
  return dt5(n3, i4, e, r);
} });
var ft5 = S4({ prefix: "\0", name: "identity", encode: (r) => at5(r), decode: (r) => ot5(r) });
var gt3 = Object.freeze({ __proto__: null, identity: ft5 });
var Et3 = d3({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var bt3 = Object.freeze({ __proto__: null, base2: Et3 });
var yt3 = d3({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
var wt3 = Object.freeze({ __proto__: null, base8: yt3 });
var Ct4 = T({ prefix: "9", name: "base10", alphabet: "0123456789" });
var mt4 = Object.freeze({ __proto__: null, base10: Ct4 });
var vt3 = d3({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 });
var At5 = d3({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var _t3 = Object.freeze({ __proto__: null, base16: vt3, base16upper: At5 });
var xt3 = d3({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 });
var Rt6 = d3({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 });
var Ft3 = d3({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
var Tt4 = d3({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 });
var It5 = d3({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 });
var Ut4 = d3({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 });
var St4 = d3({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 });
var Ot3 = d3({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 });
var qt2 = d3({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
var $t4 = Object.freeze({ __proto__: null, base32: xt3, base32upper: Rt6, base32pad: Ft3, base32padupper: Tt4, base32hex: It5, base32hexupper: Ut4, base32hexpad: St4, base32hexpadupper: Ot3, base32z: qt2 });
...
var Pt5 = Object.freeze({ __proto__: null, base36: Bt2, base36upper: Nt3 });
var zt3 = T({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" });
var Mt3 = T({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var jt = Object.freeze({ __proto__: null, base58btc: zt3, base58flickr: Mt3 });
var Lt3 = d3({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 });
var Kt3 = d3({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 });
var Vt = d3({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 });
var kt2 = d3({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
var Jt = Object.freeze({ __proto__: null, base64: Lt3, base64pad: Kt3, base64url: Vt, base64urlpad: kt2 });
var re3 = Array.from("\u{1F680}\u{1FA90}\u2604\u{1F6F0}\u{1F30C}\u{1F311}\u{1F312}\u{1F313}\u{1F314}\u{1F315}\u{1F316}\u{1F317}\u{1F318}\u{1F30D}\u{1F30F}\u{1F30E}\u{1F409}\u2600\u{1F4BB}\u{1F5A5}\u{1F4BE}\u{1F4BF}\u{1F602}\u2764\u{1F60D}\u{1F923}\u{1F60A}\u{1F64F}\u{1F495}\u{1F62D}\u{1F618}\u{1F44D}\u{1F605}\u{1F44F}\u{1F601}\u{1F525}\u{1F970}\u{1F494}\u{1F496}\u{1F499}\u{1F622}\u{1F914}\u{1F606}\u{1F644}\u{1F4AA}\u{1F609}\u263A\u{1F44C}\u{1F917}\u{1F49C}\u{1F614}\u{1F60E}\u{1F607}\u{1F339}\u{1F926}\u{1F389}\u{1F49E}\u270C\u2728\u{1F937}\u{1F631}\u{1F60C}\u{1F338}\u{1F64C}\u{1F60B}\u{1F497}\u{1F49A}\u{1F60F}\u{1F49B}\u{1F642}\u{1F493}\u{1F929}\u{1F604}\u{1F600}\u{1F5A4}\u{1F603}\u{1F4AF}\u{1F648}\u{1F447}\u{1F3B6}\u{1F612}\u{1F92D}\u2763\u{1F61C}\u{1F48B}\u{1F440}\u{1F62A}\u{1F611}\u{1F4A5}\u{1F64B}\u{1F61E}\u{1F629}\u{1F621}\u{1F92A}\u{1F44A}\u{1F973}\u{1F625}\u{1F924}\u{1F449}\u{1F483}\u{1F633}\u270B\u{1F61A}\u{1F61D}\u{1F634}\u{1F31F}\u{1F62C}\u{1F643}\u{1F340}\u{1F337}\u{1F63B}\u{1F613}\u2B50\u2705\u{1F97A}\u{1F308}\u{1F608}\u{1F918}\u{1F4A6}\u2714\u{1F623}\u{1F3C3}\u{1F490}\u2639\u{1F38A}\u{1F498}\u{1F620}\u261D\u{1F615}\u{1F33A}\u{1F382}\u{1F33B}\u{1F610}\u{1F595}\u{1F49D}\u{1F64A}\u{1F639}\u{1F5E3}\u{1F4AB}\u{1F480}\u{1F451}\u{1F3B5}\u{1F91E}\u{1F61B}\u{1F534}\u{1F624}\u{1F33C}\u{1F62B}\u26BD\u{1F919}\u2615\u{1F3C6}\u{1F92B}\u{1F448}\u{1F62E}\u{1F646}\u{1F37B}\u{1F343}\u{1F436}\u{1F481}\u{1F632}\u{1F33F}\u{1F9E1}\u{1F381}\u26A1\u{1F31E}\u{1F388}\u274C\u270A\u{1F44B}\u{1F630}\u{1F928}\u{1F636}\u{1F91D}\u{1F6B6}\u{1F4B0}\u{1F353}\u{1F4A2}\u{1F91F}\u{1F641}\u{1F6A8}\u{1F4A8}\u{1F92C}\u2708\u{1F380}\u{1F37A}\u{1F913}\u{1F619}\u{1F49F}\u{1F331}\u{1F616}\u{1F476}\u{1F974}\u25B6\u27A1\u2753\u{1F48E}\u{1F4B8}\u2B07\u{1F628}\u{1F31A}\u{1F98B}\u{1F637}\u{1F57A}\u26A0\u{1F645}\u{1F61F}\u{1F635}\u{1F44E}\u{1F932}\u{1F920}\u{1F927}\u{1F4CC}\u{1F535}\u{1F485}\u{1F9D0}\u{1F43E}\u{1F352}\u{1F617}\u{1F911}\u{1F30A}\u{1F92F}\u{1F437}\u260E\u{1F4A7}\u{1F62F}\u{1F486}\u{1F446}\u{1F3A4}\u{1F647}\u{1F351}\u2744\u{1F334}\u{1F4A3}\u{1F438}\u{1F48C}\u{1F4CD}\u{1F940}\u{1F922}\u{1F445}\u{1F4A1}\u{1F4A9}\u{1F450}\u{1F4F8}\u{1F47B}\u{1F910}\u{1F92E}\u{1F3BC}\u{1F975}\u{1F6A9}\u{1F34E}\u{1F34A}\u{1F47C}\u{1F48D}\u{1F4E3}\u{1F942}");
var Xt = re3.reduce((r, t, e) => (r[e] = t, r), []);
var Gt = re3.reduce((r, t, e) => (r[t.codePointAt(0)] = e, r), []);
function Ht(r) {
...
var Qt = S4({ prefix: "\u{1F680}", name: "base256emoji", encode: Ht, decode: Yt });
...
function ne5(r, t, e) {
  ...
  for (; r & tr3; )
    t[e++] = r & 255 | ie4, r >>>= 7;
  return t[e] = r | 0, ne5.bytes = e - i4 + 1, t;
}
var ir2 = z3;
var nr = 128;
var se = 127;
function z3(r, i4) {
  var e = 0, i4 = i4 || 0, n3 = 0, s = i4, u5, o2 = r.length;
  do {
    if (s >= o2)
      throw z3.bytes = 0, new RangeError("Could not decode varint");
    u5 = r[s++], e += n3 < 28 ? (u5 & se) << n3 : (u5 & se) * Math.pow(2, n3), n3 += 7;
  } while (u5 >= nr);
  return z3.bytes = s - i4, e;
}
var sr2 = Math.pow(2, 7);
var ur3 = Math.pow(2, 14);
var or2 = Math.pow(2, 21);
var ar2 = Math.pow(2, 28);
var Dr3 = Math.pow(2, 35);
var cr3 = Math.pow(2, 42);
var hr3 = Math.pow(2, 49);
var lr3 = Math.pow(2, 56);
var dr3 = Math.pow(2, 63);
var pr3 = function(r) {
  return r < sr2 ? 1 : r < ur3 ? 2 : r < or2 ? 3 : r < ar2 ? 4 : r < Dr3 ? 5 : r < cr3 ? 6 : r < hr3 ? 7 : r < lr3 ? 8 : r < dr3 ? 9 : 10;
};
var fr3 = { encode: Wt, decode: ir2, encodingLength: pr3 };
var ue6 = fr3;
var oe3 = (r, t, e = 0) => (ue6.encode(r, t, e), t);
var ae6 = (r) => ue6.encodingLength(r);
var M3 = (r, t) => {
  const e = t.byteLength, i4 = ae6(r), n3 = i4 + ae6(e), s = new Uint8Array(n3 + e);
  return oe3(r, s, 0), oe3(e, s, i4), s.set(t, n3), new gr3(r, e, t, s);
};
var gr3 = class {
  constructor(t, e, i4, n3) {
    this.code = t, this.size = e, this.digest = i4, this.bytes = n3;
  }
};
var De3 = ({ name: r, code: t, encode: e }) => new Er3(r, t, e);
var Er3 = class {
  constructor(t, e, i4) {
...
var ce6 = (r) => async (t) => new Uint8Array(await crypto.subtle.digest(r, t));
var br3 = De3({ name: "sha2-256", code: 18, encode: ce6("SHA-256") });
var yr3 = De3({ name: "sha2-512", code: 19, encode: ce6("SHA-512") });
var wr3 = Object.freeze({ __proto__: null, sha256: br3, sha512: yr3 });
var he3 = 0;
var Cr2 = "identity";
var le6 = ee3;
var mr3 = (r) => M3(he3, le6(r));
var vr3 = { code: he3, name: Cr2, encode: le6, digest: mr3 };
var Ar = Object.freeze({ __proto__: null, identity: vr3 });
new TextEncoder(), new TextDecoder();
var de3 = { ...gt3, ...bt3, ...wt3, ...mt4, ..._t3, ...$t4, ...Pt5, ...jt, ...Jt, ...Zt };
({ ...wr3, ...Ar });
function pe6(r, t, e, i4) {
  return { name: r, prefix: t, encoder: { name: r, prefix: t, encode: e }, decoder: { decode: i4 } };
}
var fe4 = pe6("utf8", "u", (r) => "u" + new TextDecoder("utf8").decode(r), (r) => new TextEncoder().encode(r.substring(1)));
var j3 = pe6("ascii", "a", (r) => {
  let t = "a";
  ...
  r = r.substring(1);
  const t = it5(r.length);
  for (let e = 0; e < r.length; e++)
    t[e] = r.charCodeAt(e);
  return t;
});
var ge3 = { utf8: fe4, "utf-8": fe4, hex: de3.base16, latin1: j3, ascii: j3, binary: j3, ...de3 };
function _r2(r, t = "utf8") {
  const e = ge3[t];
  if (!e)
...
var be = "utf8";
function ye(r) {
  const t = (0, import_sha2564.hash)(_r2(r, be));
  return xr(t, Ee3);
}
...
var Ce3 = (r, t, e) => t in r ? Ir3(r, t, { enumerable: true, configurable: true, writable: true, value: e }) : r[t] = e;
var L2 = (r, t) => {
  for (var e in t || (t = {}))
    Or.call(t, e) && Ce3(r, e, t[e]);
  if (we5)
    for (var e of we5(t))
      qr.call(t, e) && Ce3(r, e, t[e]);
  return r;
};
var $r = (r, t) => Ur(r, Sr(t));
var Br = class extends J5 {
  constructor(t) {
    super(t), this.initialized = false, this.name = "authEngine", this.init = () => {
      ...
      const g5 = await this.client.core.crypto.generateKeyPair(), l2 = wn3(g5);
      await this.client.authKeys.set(x2, { responseTopic: l2, publicKey: g5 }), await this.client.pairingTopics.set(l2, { topic: l2, pairingTopic: D3 }), await this.client.core.relayer.subscribe(l2), this.client.logger.info(`sending request to new pairing topic: ${D3}`);
      const c4 = await this.sendRequest(D3, "wc_authRequest", { payloadParams: { type: h3 != null ? h3 : "eip4361", chainId: n3, statement: s, aud: u5, domain: o2, version: "1", nonce: a3, iat: new Date().toISOString() }, requester: { publicKey: g5, metadata: this.client.metadata } }, {}, e.expiry);
      return this.client.logger.info(`sent request to new pairing topic: ${D3}`), { uri: p6, id: c4 };
    }, this.respond = async (e, i4) => {
      if (this.isInitialized(), !rt5(e, this.client.requests))
        throw new Error("Invalid response");
      const n3 = W4(this.client.requests, e.id), s = n3.requester.publicKey, u5 = await this.client.core.crypto.generateKeyPair(), o2 = wn3(s), a3 = { type: U5, receiverPublicKey: s, senderPublicKey: u5 };
      if ("error" in e) {
        await this.sendError(n3.id, o2, e, a3);
        return;
      }
      const h3 = { h: { t: "eip4361" }, p: $r(L2({}, n3.cacaoPayload), { iss: i4 }), s: e.signature }, D3 = await this.sendResult(n3.id, o2, h3, a3);
      await this.client.requests.update(D3, L2({}, h3));
    }, this.getPendingRequests = () => Z(this.client.requests), this.formatMessage = (e, i4) => {
      this.client.logger.debug(`formatMessage, cacao is: ${JSON.stringify(e)}`);
      const n3 = `${e.domain} wants you to sign in with your Ethereum account:`, s = Q3(i4), u5 = e.statement, o2 = `URI: ${e.aud}`, a3 = `Version: ${e.version}`, h3 = `Chain ID: ${He5(i4)}`, D3 = `Nonce: ${e.nonce}`, p6 = `Issued At: ${e.iat}`, g5 = e.resources && e.resources.length > 0 ? `Resources:
...
`);
    ...
    }, this.sendRequest = async (e, i4, n3, s, u5) => {
      const o2 = formatJsonRpcRequest(i4, n3), a3 = await this.client.core.crypto.encode(e, o2, s), h3 = R3[i4].req;
      return u5 && (h3.ttl = u5), this.client.core.history.set(e, o2), await this.client.core.relayer.publish(e, a3, h3), o2.id;
    }, this.sendResult = async (e, i4, n3, s) => {
      const u5 = formatJsonRpcResult(e, n3), o2 = await this.client.core.crypto.encode(i4, u5, s), a3 = await this.client.core.history.get(i4, e), h3 = R3[a3.request.method].res;
      return await this.client.core.relayer.publish(i4, o2, h3), await this.client.core.history.resolve(u5), u5.id;
    }, this.sendError = async (e, i4, n3, s) => {
      const u5 = formatJsonRpcError(e, n3.error), o2 = await this.client.core.crypto.encode(i4, u5, s), a3 = await this.client.core.history.get(i4, e), h3 = R3[a3.request.method].res;
      return await this.client.core.relayer.publish(i4, o2, h3), await this.client.core.history.resolve(u5), u5.id;
      ...
      const { publicKey: s } = this.client.authKeys.get(x2), { chainId: u5, statement: o2, aud: a3, domain: h3, nonce: D3, type: p6 } = i4, g5 = await this.sendRequest(n3.topic, "wc_authRequest", { payloadParams: { type: p6 != null ? p6 : "eip4361", chainId: u5, statement: o2, aud: a3, domain: h3, version: "1", nonce: D3, iat: new Date().toISOString() }, requester: { publicKey: s, metadata: this.client.metadata } }, {}, i4.expiry);
      return this.client.logger.info(`sent request to known pairing topic: ${n3.topic}`), { id: g5 };
    }, this.onRelayEventRequest = (e) => {
      const { topic: i4, payload: n3 } = e, s = n3.method;
      switch (s) {
        case "wc_authRequest":
          return this.onAuthRequest(i4, n3);
        default:
          return this.client.logger.info(`Unsupported request method ${s}`);
      }
    }, this.onRelayEventResponse = async (e) => {
      const { topic: i4, payload: n3 } = e, s = (await this.client.core.history.get(i4, n3.id)).request.method;
      switch (s) {
        case "wc_authRequest":
          return this.onAuthResponse(i4, n3);
        default:
          return this.client.logger.info(`Unsupported response method ${s}`);
      }
    }, this.onAuthRequest = async (e, i4) => {
      const { requester: n3, payloadParams: { resources: s, statement: u5, aud: o2, domain: a3, version: h3, nonce: D3, iat: p6, chainId: g5 } } = i4.params;
      ...
      try {
        ...
        await this.client.requests.set(i4.id, { requester: n3, pairingTopic: e, id: i4.id, cacaoPayload: l2 });
        const c4 = ye(JSON.stringify(i4)), f8 = await this.getVerifyContext(c4, this.client.metadata);
        this.client.emit("auth_request", { id: i4.id, topic: e, params: { requester: n3, cacaoPayload: l2 }, verifyContext: f8 });
      } catch (l2) {
        await this.sendError(i4.id, e, l2), this.client.logger.error(l2);
      }
      ...
      if (this.client.logger.info({ type: "onAuthResponse", topic: e, response: i4 }), isJsonRpcResult(i4)) {
        ...
        const { s: u5, p: o2 } = i4.result;
        await this.client.requests.set(n3, L2({ id: n3, pairingTopic: s }, i4.result));
...
`, JSON.stringify(a3)), this.client.logger.debug("payload.iss:", o2.iss), this.client.logger.debug("signature:", u5);
        const h3 = Q3(o2.iss), D3 = Ye3(o2.iss);
        if (!h3)
          throw new Error("Could not derive address from `payload.iss`");
        if (!D3)
          throw new Error("Could not derive chainId from `payload.iss`");
        this.client.logger.debug("walletAddress extracted from `payload.iss`:", h3), await Qe3(h3, a3, u5, D3, this.client.projectId) ? this.client.emit("auth_response", { id: n3, topic: e, params: i4 }) : this.client.emit("auth_response", { id: n3, topic: e, params: { message: "Invalid signature", code: -1 } });
      } else
        isJsonRpcError(i4) && this.client.emit("auth_response", { id: n3, topic: e, params: i4 });
    }, this.getVerifyContext = async (e, i4) => {
      const n3 = { verified: { verifyUrl: i4.verifyUrl || "", validation: "UNKNOWN", origin: i4.url || "" } };
      try {
        const s = await this.client.core.verify.resolve({ attestationId: e, verifyUrl: i4.verifyUrl });
        s && (n3.verified.origin = s, n3.verified.validation = s === i4.url ? "VALID" : "INVALID");
      } catch (s) {
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: t } = N5("NOT_INITIALIZED", this.name);
      throw new Error(t);
    }
  }
  registerRelayerEvents() {
    this.client.core.relayer.on(g3.message, async (t) => {
      const { topic: e, message: i4 } = t, { responseTopic: n3, publicKey: s } = this.client.authKeys.keys.includes(x2) ? this.client.authKeys.get(x2) : { responseTopic: void 0, publicKey: void 0 };
      if (n3 && e !== n3) {
        this.client.logger.debug("[Auth] Ignoring message from unknown topic", e);
        return;
      }
      const u5 = await this.client.core.crypto.decode(e, i4, { receiverPublicKey: s });
...
var O = class extends X4 {
  constructor(t) {
    super(t), this.protocol = B, this.version = H2, this.name = N6, this.events = new import_events8.EventEmitter(), this.emit = (i4, n3) => this.events.emit(i4, n3), this.on = (i4, n3) => this.events.on(i4, n3), this.once = (i4, n3) => this.events.once(i4, n3), this.off = (i4, n3) => this.events.off(i4, n3), this.removeListener = (i4, n3) => this.events.removeListener(i4, n3), this.request = async (i4, n3) => {
      try {
        return await this.engine.request(i4, n3);
      } catch (s) {
        throw this.logger.error(s.message), s;
      }
    }, this.respond = async (i4, n3) => {
      try {
        return await this.engine.respond(i4, n3);
      } catch (s) {
        throw this.logger.error(s.message), s;
      }
    ...
    }, this.formatMessage = (i4, n3) => {
      try {
        return this.engine.formatMessage(i4, n3);
      } catch (s) {
        throw this.logger.error(s.message), s;
      }
    };
    const e = typeof t.logger < "u" && typeof t.logger != "string" ? t.logger : (0, import_logger3.pino)((0, import_logger3.getDefaultLoggerOptions)({ level: t.logger || "error" }));
    this.name = (t == null ? void 0 : t.name) || N6, this.metadata = t.metadata, this.projectId = t.projectId, this.core = t.core || new _r(t), this.logger = (0, import_logger3.generateChildLogger)(e, this.name), this.authKeys = new At4(this.core, this.logger, "authKeys", F2, () => x2), this.pairingTopics = new At4(this.core, this.logger, "pairingTopics", F2), this.requests = new At4(this.core, this.logger, "requests", F2), this.engine = new Br(this);
  }
  static async init(t) {
    const e = new O(t);
...
var import_sha2565 = __toESM(require_sha256());
var ue7 = __toESM(require_x25519());
init_es();
var import_time7 = __toESM(require_cjs());
var import_window_getters4 = __toESM(require_cjs3());
var import_window_metadata4 = __toESM(require_cjs4());
var $7 = __toESM(require_query_string4());
function V2(e, n3) {
...
var U7 = 1;
function jn3(e) {
  const n3 = (0, import_sha2565.hash)(fromString(e, k3));
  return toString(n3, f6);
}
function X5() {
  return typeof import_process.default < "u" && typeof import_process.default.versions < "u" && typeof import_process.default.versions.node < "u";
}
function Ce4() {
  return !X5() && !!(0, import_window_getters4.getNavigator)();
}
function Fn() {
  return (0, import_window_metadata4.getWindowMetadata)() || { name: "", description: "", url: "", icons: [""] };
}
function b2(e, n3) {
  return e.filter((t) => n3.includes(t)).length === e.length;
}
function Xn3(e = import_time7.FIVE_MINUTES, n3) {
  const t = (0, import_time7.toMiliseconds)(e || import_time7.FIVE_MINUTES);
  let r, o2, s;
  return { resolve: (c4) => {
    s && r && (clearTimeout(s), r(c4));
  }, reject: (c4) => {
...
function ot6(e, n3) {
  return (0, import_time7.fromMiliseconds)((n3 || Date.now()) + (0, import_time7.toMiliseconds)(e));
}
function st6(e) {
  return Date.now() >= (0, import_time7.toMiliseconds)(e);
}
function it6(e, n3) {
  return `${e}${n3 ? `:${n3}` : ""}`;
}
...
function Ye4(e) {
  ...
  return Object.values(e).forEach((t) => {
    n3.push(...T2(t.accounts));
  }), n3;
}
function Je3(e, n3) {
  const t = [];
  return Object.values(e).forEach((r) => {
    T2(r.accounts).includes(n3) && t.push(...r.methods);
  }), t;
}
function Qe4(e, n3) {
  const t = [];
  return Object.values(e).forEach((r) => {
    T2(r.accounts).includes(n3) && t.push(...r.events);
  }), t;
}
function Ot4(e, n3) {
  const t = sn(e, n3);
  ...
  for (const [o2, s] of Object.entries(e))
    r[o2] = { methods: s.methods, events: s.events, chains: s.accounts.map((c4) => `${c4.split(":")[0]}:${c4.split(":")[1]}`) };
  return r;
}
var It6 = { INVALID_METHOD: { message: "Invalid method.", code: 1001 }, INVALID_EVENT: { message: "Invalid event.", code: 1002 }, INVALID_UPDATE_REQUEST: { message: "Invalid update request.", code: 1003 }, INVALID_EXTEND_REQUEST: { message: "Invalid extend request.", code: 1004 }, INVALID_SESSION_SETTLE_REQUEST: { message: "Invalid session settle request.", code: 1005 }, UNAUTHORIZED_METHOD: { message: "Unauthorized method.", code: 3001 }, UNAUTHORIZED_EVENT: { message: "Unauthorized event.", code: 3002 }, UNAUTHORIZED_UPDATE_REQUEST: { message: "Unauthorized update request.", code: 3003 }, UNAUTHORIZED_EXTEND_REQUEST: { message: "Unauthorized extend request.", code: 3004 }, USER_REJECTED: { message: "User rejected.", code: 5e3 }, USER_REJECTED_CHAINS: { message: "User rejected chains.", code: 5001 }, USER_REJECTED_METHODS: { message: "User rejected methods.", code: 5002 }, USER_REJECTED_EVENTS: { message: "User rejected events.", code: 5003 }, UNSUPPORTED_CHAINS: { message: "Unsupported chains.", code: 5100 }, UNSUPPORTED_METHODS: { message: "Unsupported methods.", code: 5101 }, UNSUPPORTED_EVENTS: { message: "Unsupported events.", code: 5102 }, UNSUPPORTED_ACCOUNTS: { message: "Unsupported accounts.", code: 5103 }, UNSUPPORTED_NAMESPACE_KEY: { message: "Unsupported namespace key.", code: 5104 }, USER_DISCONNECTED: { message: "User disconnected.", code: 6e3 }, SESSION_SETTLEMENT_FAILED: { message: "Session settlement failed.", code: 7e3 }, WC_METHOD_UNSUPPORTED: { message: "Unsupported wc_ method.", code: 10001 } };
var Pt6 = { NOT_INITIALIZED: { message: "Not initialized.", code: 1 }, NO_MATCHING_KEY: { message: "No matching key.", code: 2 }, RESTORE_WILL_OVERRIDE: { message: "Restore will override.", code: 3 }, RESUBSCRIBED: { message: "Resubscribed.", code: 4 }, MISSING_OR_INVALID: { message: "Missing or invalid.", code: 5 }, EXPIRED: { message: "Expired.", code: 6 }, UNKNOWN_TYPE: { message: "Unknown type.", code: 7 }, MISMATCHED_TOPIC: { message: "Mismatched topic.", code: 8 }, NON_CONFORMING_NAMESPACES: { message: "Non conforming namespaces.", code: 9 } };
function N7(e, n3) {
  const { message: t, code: r } = Pt6[e];
  return { message: n3 ? `${t} ${n3}` : t, code: r };
}
function R4(e, n3) {
  const { message: t, code: r } = It6[e];
  return { message: n3 ? `${t} ${n3}` : t, code: r };
}
function C5(e, n3) {
  return Array.isArray(e) ? typeof n3 < "u" && e.length ? e.every(n3) : true : false;
...
function m5(e, n3) {
  return n3 && S6(e) ? true : typeof e == "string" && Boolean(e.trim().length);
}
function F3(e, n3) {
  return n3 && S6(e) ? true : typeof e == "number" && !isNaN(e);
}
function Tt5(e, n3) {
  const { requiredNamespaces: t } = n3, r = Object.keys(e.namespaces), o2 = Object.keys(t);
  let s = true;
  return b2(o2, r) ? (r.forEach((c4) => {
    const { accounts: d5, methods: l2, events: i4 } = e.namespaces[c4], u5 = T2(d5), a3 = t[c4];
    (!b2(V2(c4, a3), u5) || !b2(a3.methods, l2) || !b2(a3.events, i4)) && (s = false);
  }), s) : false;
}
function H3(e) {
  return m5(e, false) && e.includes(":") ? e.split(":").length === 2 : false;
}
function Xe3(e) {
  if (m5(e, false) && e.includes(":")) {
    const n3 = e.split(":");
    if (n3.length === 3) {
      const t = n3[0] + ":" + n3[1];
      return !!n3[2] && H3(t);
...
function _t4(e, n3) {
  let t = null;
  return m5(e == null ? void 0 : e.publicKey, false) || (t = N7("MISSING_OR_INVALID", `${n3} controller public key should be a string`)), t;
}
function oe4(e) {
  let n3 = true;
  return C5(e) ? e.length && (n3 = e.every((t) => m5(t, false))) : n3 = false, n3;
}
function en(e, n3, t) {
  let r = null;
  return C5(n3) ? n3.forEach((o2) => {
    r || (!H3(o2) || !o2.includes(e)) && (r = R4("UNSUPPORTED_CHAINS", `${t}, chain ${o2} should be a string and conform to "namespace:chainId" format`));
  }) : r = R4("UNSUPPORTED_CHAINS", `${t}, chains ${n3} should be an array of strings conforming to "namespace:chainId" format`), r;
}
function nn(e, n3) {
  let t = null;
  return Object.entries(e).forEach(([r, o2]) => {
    if (t)
      return;
    const s = en(r, V2(r, o2), `${n3} requiredNamespace`);
    s && (t = s);
  }), t;
}
function tn(e, n3) {
  let t = null;
  return C5(e) ? e.forEach((r) => {
    t || Xe3(r) || (t = R4("UNSUPPORTED_ACCOUNTS", `${n3}, account ${r} should be a string and conform to "namespace:chainId:address" format`));
  }) : t = R4("UNSUPPORTED_ACCOUNTS", `${n3}, accounts should be an array of strings conforming to "namespace:chainId:address" format`), t;
}
function rn(e, n3) {
  let t = null;
  return Object.values(e).forEach((r) => {
...
function on(e, n3) {
  let t = null;
  return oe4(e == null ? void 0 : e.methods) ? oe4(e == null ? void 0 : e.events) || (t = R4("UNSUPPORTED_EVENTS", `${n3}, events should be an array of strings or empty array for no events`)) : t = R4("UNSUPPORTED_METHODS", `${n3}, methods should be an array of strings or empty array for no methods`), t;
}
function se2(e, n3) {
  let t = null;
  return Object.values(e).forEach((r) => {
...
function wt4(e, n3, t) {
  ...
  if (e && x3(e)) {
    ...
    r = N7("MISSING_OR_INVALID", `${n3}, ${t} should be an object with data`);
  return r;
}
function sn(e, n3) {
  let t = null;
  if (e && x3(e)) {
    ...
    t = N7("MISSING_OR_INVALID", `${n3}, namespaces should be an object with data`);
  return t;
}
function cn(e) {
  return m5(e.protocol, true);
}
function jt2(e, n3) {
  let t = false;
  return n3 && !e ? t = true : e && C5(e) && e.length && e.forEach((r) => {
    t = cn(r);
  }), t;
}
function Ct5(e) {
...
function Dt4(e) {
  return !(!e || typeof e != "object" || !e.code || !F3(e.code, false) || !e.message || !m5(e.message, false));
}
function Vt2(e) {
  return !(S6(e) || !m5(e.method, false));
}
function Mt4(e) {
  return !(S6(e) || S6(e.result) && S6(e.error) || !F3(e.id, false) || !m5(e.jsonrpc, false));
}
function Kt4(e) {
  return !(S6(e) || !m5(e.name, false));
}
function kt3(e, n3) {
  return !(!H3(n3) || !Ye4(e).includes(n3));
}
function Lt4(e, n3, t) {
  return m5(t, false) ? Je3(e, n3).includes(t) : false;
}
function xt4(e, n3, t) {
  return m5(t, false) ? Qe4(e, n3).includes(t) : false;
}
function an(e, n3, t) {
  let r = null;
  const o2 = Ft4(e), s = Ht2(n3), c4 = Object.keys(o2), d5 = Object.keys(s), l2 = un(Object.keys(e)), i4 = un(Object.keys(n3)), u5 = l2.filter((a3) => !i4.includes(a3));
  return u5.length && (r = N7("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
      Required: ${u5.toString()}
      Received: ${Object.keys(n3).toString()}`)), b2(c4, d5) || (r = N7("NON_CONFORMING_NAMESPACES", `${t} namespaces chains don't satisfy required namespaces.
      Required: ${c4.toString()}
      Approved: ${d5.toString()}`)), Object.keys(n3).forEach((a3) => {
    if (!a3.includes(":") || r)
      return;
    const g5 = T2(n3[a3].accounts);
    g5.includes(a3) || (r = N7("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${a3}
        Required: ${a3}
        Approved: ${g5.toString()}`));
  }), c4.forEach((a3) => {
    r || (b2(o2[a3].methods, s[a3].methods) ? b2(o2[a3].events, s[a3].events) || (r = N7("NON_CONFORMING_NAMESPACES", `${t} namespaces events don't satisfy namespace events for ${a3}`)) : r = N7("NON_CONFORMING_NAMESPACES", `${t} namespaces methods don't satisfy namespace methods for ${a3}`));
  }), r;
}
function Ft4(e) {
  const n3 = {};
...
function qt3(e, n3) {
  return F3(e, false) && e <= n3.max && e >= n3.min;
}
...
var J6 = "client";
var L3 = `${j4}@${k4}:${J6}:`;
var b3 = { name: J6, logger: "error", controller: false, relayUrl: "wss://relay.walletconnect.com" };
var ee4 = "proposal";
var se3 = "Proposal expired";
var te2 = "session";
var A2 = import_time8.SEVEN_DAYS;
var ie6 = "engine";
var O2 = { wc_sessionPropose: { req: { ttl: import_time8.FIVE_MINUTES, prompt: true, tag: 1100 }, res: { ttl: import_time8.FIVE_MINUTES, prompt: false, tag: 1101 } }, wc_sessionSettle: { req: { ttl: import_time8.FIVE_MINUTES, prompt: false, tag: 1102 }, res: { ttl: import_time8.FIVE_MINUTES, prompt: false, tag: 1103 } }, wc_sessionUpdate: { req: { ttl: import_time8.ONE_DAY, prompt: false, tag: 1104 }, res: { ttl: import_time8.ONE_DAY, prompt: false, tag: 1105 } }, wc_sessionExtend: { req: { ttl: import_time8.ONE_DAY, prompt: false, tag: 1106 }, res: { ttl: import_time8.ONE_DAY, prompt: false, tag: 1107 } }, wc_sessionRequest: { req: { ttl: import_time8.FIVE_MINUTES, prompt: true, tag: 1108 }, res: { ttl: import_time8.FIVE_MINUTES, prompt: false, tag: 1109 } }, wc_sessionEvent: { req: { ttl: import_time8.FIVE_MINUTES, prompt: true, tag: 1110 }, res: { ttl: import_time8.FIVE_MINUTES, prompt: false, tag: 1111 } }, wc_sessionDelete: { req: { ttl: import_time8.ONE_DAY, prompt: false, tag: 1112 }, res: { ttl: import_time8.ONE_DAY, prompt: false, tag: 1113 } }, wc_sessionPing: { req: { ttl: import_time8.THIRTY_SECONDS, prompt: false, tag: 1114 }, res: { ttl: import_time8.THIRTY_SECONDS, prompt: false, tag: 1115 } } };
var G6 = { min: import_time8.FIVE_MINUTES, max: import_time8.SEVEN_DAYS };
var re4 = "request";
var ne6 = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest"];
var Be4 = Object.defineProperty;
var Qe5 = Object.defineProperties;
var We4 = Object.getOwnPropertyDescriptors;
var oe5 = Object.getOwnPropertySymbols;
var Ze4 = Object.prototype.hasOwnProperty;
var es3 = Object.prototype.propertyIsEnumerable;
var ae8 = (d5, r, e) => r in d5 ? Be4(d5, r, { enumerable: true, configurable: true, writable: true, value: e }) : d5[r] = e;
var w2 = (d5, r) => {
  for (var e in r || (r = {}))
    Ze4.call(r, e) && ae8(d5, e, r[e]);
  if (oe5)
    for (var e of oe5(r))
      es3.call(r, e) && ae8(d5, e, r[e]);
  return d5;
};
var X6 = (d5, r) => Qe5(d5, We4(r));
var ss3 = class extends S5 {
  constructor(r) {
    super(r), this.name = ie6, this.events = new import_events11.default(), this.initialized = false, this.ignoredPayloadTypes = [U7], this.init = async () => {
      ...
      this.isInitialized();
      const s = X6(w2({}, e), { requiredNamespaces: e.requiredNamespaces || {}, optionalNamespaces: e.optionalNamespaces || {} });
      await this.isValidConnect(s);
      const { pairingTopic: t, requiredNamespaces: i4, optionalNamespaces: n3, sessionProperties: a3, relays: o2 } = s;
      let l2 = t, h3, I3 = false;
      if (l2 && (I3 = this.client.core.pairing.pairings.get(l2).active), !l2 || !I3) {
        const { topic: v, uri: y4 } = await this.client.core.pairing.create();
        l2 = v, h3 = y4;
      }
      const g5 = await this.client.core.crypto.generateKeyPair(), f8 = w2({ requiredNamespaces: i4, optionalNamespaces: n3, relays: o2 != null ? o2 : [{ protocol: st4 }], proposer: { publicKey: g5, metadata: this.client.metadata } }, a3 && { sessionProperties: a3 }), { reject: m7, resolve: V3, done: M5 } = Xn3(import_time8.FIVE_MINUTES, se3);
      if (this.events.once(it6("session_connect"), async ({ error: v, session: y4 }) => {
        if (v)
          m7(v);
        else if (y4) {
          y4.self.publicKey = g5;
          const H4 = X6(w2({}, y4), { requiredNamespaces: y4.requiredNamespaces, optionalNamespaces: y4.optionalNamespaces });
          await this.client.session.set(y4.topic, H4), await this.setExpiry(y4.topic, y4.expiry), l2 && await this.client.core.pairing.updateMetadata({ topic: l2, metadata: y4.peer.metadata }), V3(H4);
        }
      }), !l2) {
        const { message: v } = N7("NO_MATCHING_KEY", `connect() pairing topic: ${l2}`);
        throw new Error(v);
      }
      const C7 = await this.sendRequest(l2, "wc_sessionPropose", f8), ce8 = ot6(import_time8.FIVE_MINUTES);
      return await this.setProposal(C7, w2({ id: C7, expiry: ce8 }, f8)), { uri: h3, approval: M5 };
      ...
      const { id: s, relayProtocol: t, namespaces: i4, sessionProperties: n3 } = e, a3 = this.client.proposal.get(s);
      let { pairingTopic: o2, proposer: l2, requiredNamespaces: h3, optionalNamespaces: I3 } = a3;
      o2 = o2 || "", x3(h3) || (h3 = Ot4(i4, "approve()"));
      const g5 = await this.client.core.crypto.generateKeyPair(), f8 = l2.publicKey, m7 = await this.client.core.crypto.generateSharedKey(g5, f8);
      o2 && s && (await this.client.core.pairing.updateMetadata({ topic: o2, metadata: l2.metadata }), await this.sendResult(s, o2, { relay: { protocol: t != null ? t : "irn" }, responderPublicKey: g5 }), await this.client.proposal.delete(s, R4("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: o2 }));
      const V3 = w2({ relay: { protocol: t != null ? t : "irn" }, namespaces: i4, requiredNamespaces: h3, optionalNamespaces: I3, pairingTopic: o2, controller: { publicKey: g5, metadata: this.client.metadata }, expiry: ot6(A2) }, n3 && { sessionProperties: n3 });
      await this.client.core.relayer.subscribe(m7), await this.sendRequest(m7, "wc_sessionSettle", V3);
      const M5 = X6(w2({}, V3), { topic: m7, pairingTopic: o2, acknowledged: false, self: V3.controller, peer: { publicKey: l2.publicKey, metadata: l2.metadata }, controller: g5 });
      return await this.client.session.set(m7, M5), await this.setExpiry(m7, ot6(A2)), { topic: m7, acknowledged: () => new Promise((C7) => setTimeout(() => C7(this.client.session.get(m7)), 500)) };
    }, this.reject = async (e) => {
      this.isInitialized(), await this.isValidReject(e);
      const { id: s, reason: t } = e, { pairingTopic: i4 } = this.client.proposal.get(s);
      i4 && (await this.sendError(s, i4, t), await this.client.proposal.delete(s, R4("USER_DISCONNECTED")));
    }, this.update = async (e) => {
      this.isInitialized(), await this.isValidUpdate(e);
      const { topic: s, namespaces: t } = e, i4 = await this.sendRequest(s, "wc_sessionUpdate", { namespaces: t }), { done: n3, resolve: a3, reject: o2 } = Xn3();
      return this.events.once(it6("session_update", i4), ({ error: l2 }) => {
        l2 ? o2(l2) : a3();
      }), await this.client.session.update(s, { namespaces: t }), { acknowledged: n3 };
    }, this.extend = async (e) => {
      this.isInitialized(), await this.isValidExtend(e);
      const { topic: s } = e, t = await this.sendRequest(s, "wc_sessionExtend", {}), { done: i4, resolve: n3, reject: a3 } = Xn3();
      return this.events.once(it6("session_extend", t), ({ error: o2 }) => {
        o2 ? a3(o2) : n3();
      }), await this.setExpiry(s, ot6(A2)), { acknowledged: i4 };
    }, this.request = async (e) => {
      this.isInitialized(), await this.isValidRequest(e);
      const { chainId: s, request: t, topic: i4, expiry: n3 } = e, a3 = await this.sendRequest(i4, "wc_sessionRequest", { request: t, chainId: s }, n3), { done: o2, resolve: l2, reject: h3 } = Xn3(n3);
      return this.events.once(it6("session_request", a3), ({ error: I3, result: g5 }) => {
        I3 ? h3(I3) : l2(g5);
      }), this.client.events.emit("session_request_sent", { topic: i4, request: t, chainId: s, id: a3 }), await o2();
    }, this.respond = async (e) => {
      this.isInitialized(), await this.isValidRespond(e);
      const { topic: s, response: t } = e, { id: i4 } = t;
      isJsonRpcResult(t) ? await this.sendResult(i4, s, t.result) : isJsonRpcError(t) && await this.sendError(i4, s, t.error), this.deletePendingSessionRequest(e.response.id, { message: "fulfilled", code: 0 });
    }, this.ping = async (e) => {
      this.isInitialized(), await this.isValidPing(e);
      const { topic: s } = e;
      if (this.client.session.keys.includes(s)) {
        const t = await this.sendRequest(s, "wc_sessionPing", {}), { done: i4, resolve: n3, reject: a3 } = Xn3();
        this.events.once(it6("session_ping", t), ({ error: o2 }) => {
          o2 ? a3(o2) : n3();
        }), await i4();
      } else
      ...
      const { topic: s, event: t, chainId: i4 } = e;
      await this.sendRequest(s, "wc_sessionEvent", { event: t, chainId: i4 });
    }, this.disconnect = async (e) => {
      this.isInitialized(), await this.isValidDisconnect(e);
      const { topic: s } = e;
      this.client.session.keys.includes(s) ? (await this.sendRequest(s, "wc_sessionDelete", R4("USER_DISCONNECTED")), await this.deleteSession(s)) : await this.client.core.pairing.disconnect({ topic: s });
    }, this.find = (e) => (this.isInitialized(), this.client.session.getAll().filter((s) => Tt5(s, e))), this.getPendingSessionRequests = () => (this.isInitialized(), this.client.pendingRequest.getAll()), this.cleanupDuplicatePairings = async (e) => {
      try {
        const s = this.client.core.pairing.pairings.get(e.pairingTopic), t = this.client.core.pairing.pairings.getAll().filter((i4) => {
          var n3, a3;
          return ((n3 = i4.peerMetadata) == null ? void 0 : n3.url) && ((a3 = i4.peerMetadata) == null ? void 0 : a3.url) === e.self.metadata.url && i4.topic !== s.topic;
        });
        if (t.length === 0)
          return;
        this.client.logger.info(`Cleaning up ${t.length} duplicate pairing(s)`), await Promise.all(t.map((i4) => this.client.core.pairing.disconnect({ topic: i4.topic }))), this.client.logger.info("Duplicate pairings clean up finished");
      } catch (s) {
        this.client.logger.error(s);
      }
    }, this.deleteSession = async (e, s) => {
      const { self: t } = this.client.session.get(e);
      await this.client.core.relayer.unsubscribe(e), await Promise.all([this.client.session.delete(e, R4("USER_DISCONNECTED")), this.client.core.crypto.deleteKeyPair(t.publicKey), this.client.core.crypto.deleteSymKey(e), s ? Promise.resolve() : this.client.core.expirer.del(e)]);
    }, this.deleteProposal = async (e, s) => {
      await Promise.all([this.client.proposal.delete(e, R4("USER_DISCONNECTED")), s ? Promise.resolve() : this.client.core.expirer.del(e)]);
      ...
      const s = O2.wc_sessionRequest.req.ttl, { id: t, topic: i4, params: n3 } = e;
      await this.client.pendingRequest.set(t, { id: t, topic: i4, params: n3 }), s && this.client.core.expirer.set(t, ot6(s));
    }, this.sendRequest = async (e, s, t, i4) => {
      const n3 = formatJsonRpcRequest(s, t);
      if (Ce4() && ne6.includes(s)) {
        const l2 = jn3(JSON.stringify(n3));
        await this.client.core.verify.register({ attestationId: l2 });
      }
      const a3 = await this.client.core.crypto.encode(e, n3), o2 = O2[s].req;
      return i4 && (o2.ttl = i4), this.client.core.history.set(e, n3), this.client.core.relayer.publish(e, a3, o2), n3.id;
    }, this.sendResult = async (e, s, t) => {
      const i4 = formatJsonRpcResult(e, t), n3 = await this.client.core.crypto.encode(s, i4), a3 = await this.client.core.history.get(s, e), o2 = O2[a3.request.method].res;
      this.client.core.relayer.publish(s, n3, o2), await this.client.core.history.resolve(i4);
    }, this.sendError = async (e, s, t) => {
      const i4 = formatJsonRpcError(e, t), n3 = await this.client.core.crypto.encode(s, i4), a3 = await this.client.core.history.get(s, e), o2 = O2[a3.request.method].res;
      this.client.core.relayer.publish(s, n3, o2), await this.client.core.history.resolve(i4);
    }, this.cleanup = async () => {
      const e = [], s = [];
      this.client.session.getAll().forEach((t) => {
        st6(t.expiry) && e.push(t.topic);
      }), this.client.proposal.getAll().forEach((t) => {
        st6(t.expiry) && s.push(t.id);
      }), await Promise.all([...e.map((t) => this.deleteSession(t)), ...s.map((t) => this.deleteProposal(t))]);
    }, this.onRelayEventRequest = (e) => {
      const { topic: s, payload: t } = e, i4 = t.method;
      switch (i4) {
      ...
      const { topic: s, payload: t } = e, i4 = (await this.client.core.history.get(s, t.id)).request.method;
      switch (i4) {
        case "wc_sessionPropose":
      ...
      const { params: t, id: i4 } = s;
      try {
        this.isValidConnect(w2({}, s.params));
        const n3 = ot6(import_time8.FIVE_MINUTES), a3 = w2({ id: i4, pairingTopic: e, expiry: n3 }, t);
        await this.setProposal(i4, a3);
        const o2 = jn3(JSON.stringify(s)), l2 = await this.getVerifyContext(o2, a3.proposer.metadata);
        this.client.events.emit("session_proposal", { id: i4, params: a3, verifyContext: l2 });
      } catch (n3) {
        await this.sendError(i4, e, n3), this.client.logger.error(n3);
      }
      ...
      if (isJsonRpcResult(s)) {
        ...
        const o2 = i4.responderPublicKey;
        this.client.logger.trace({ type: "method", method: "onSessionProposeResponse", peerPublicKey: o2 });
        const l2 = await this.client.core.crypto.generateSharedKey(a3, o2);
        ...
        isJsonRpcError(s) && (await this.client.proposal.delete(t, R4("USER_DISCONNECTED")), this.events.emit(it6("session_connect"), { error: s.error }));
    }, this.onSessionSettleRequest = async (e, s) => {
      const { id: t, params: i4 } = s;
      try {
        this.isValidSessionSettleRequest(i4);
        const { relay: n3, controller: a3, expiry: o2, namespaces: l2, requiredNamespaces: h3, optionalNamespaces: I3, sessionProperties: g5, pairingTopic: f8 } = s.params, m7 = w2({ topic: e, relay: n3, expiry: o2, namespaces: l2, acknowledged: true, pairingTopic: f8, requiredNamespaces: h3, optionalNamespaces: I3, controller: a3.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: a3.publicKey, metadata: a3.metadata } }, g5 && { sessionProperties: g5 });
        await this.sendResult(s.id, e, true), this.events.emit(it6("session_connect"), { session: m7 }), this.cleanupDuplicatePairings(m7);
      } catch (n3) {
        await this.sendError(t, e, n3), this.client.logger.error(n3);
      }
    }, this.onSessionSettleResponse = async (e, s) => {
      const { id: t } = s;
      isJsonRpcResult(s) ? (await this.client.session.update(e, { acknowledged: true }), this.events.emit(it6("session_approve", t), {})) : isJsonRpcError(s) && (await this.client.session.delete(e, R4("USER_DISCONNECTED")), this.events.emit(it6("session_approve", t), { error: s.error }));
    }, this.onSessionUpdateRequest = async (e, s) => {
      const { params: t, id: i4 } = s;
      try {
        this.isValidUpdate(w2({ topic: e }, t)), await this.client.session.update(e, { namespaces: t.namespaces }), await this.sendResult(i4, e, true), this.client.events.emit("session_update", { id: i4, topic: e, params: t });
      } catch (n3) {
        await this.sendError(i4, e, n3), this.client.logger.error(n3);
      }
    }, this.onSessionUpdateResponse = (e, s) => {
      const { id: t } = s;
      isJsonRpcResult(s) ? this.events.emit(it6("session_update", t), {}) : isJsonRpcError(s) && this.events.emit(it6("session_update", t), { error: s.error });
    }, this.onSessionExtendRequest = async (e, s) => {
      const { id: t } = s;
      try {
        this.isValidExtend({ topic: e }), await this.setExpiry(e, ot6(A2)), await this.sendResult(t, e, true), this.client.events.emit("session_extend", { id: t, topic: e });
      } catch (i4) {
        await this.sendError(t, e, i4), this.client.logger.error(i4);
      }
    }, this.onSessionExtendResponse = (e, s) => {
      const { id: t } = s;
      isJsonRpcResult(s) ? this.events.emit(it6("session_extend", t), {}) : isJsonRpcError(s) && this.events.emit(it6("session_extend", t), { error: s.error });
      ...
      const { id: t } = s;
      setTimeout(() => {
        isJsonRpcResult(s) ? this.events.emit(it6("session_ping", t), {}) : isJsonRpcError(s) && this.events.emit(it6("session_ping", t), { error: s.error });
      }, 500);
    }, this.onSessionDeleteRequest = async (e, s) => {
      const { id: t } = s;
      try {
        this.isValidDisconnect({ topic: e, reason: s.params }), await Promise.all([new Promise((i4) => {
          this.client.core.relayer.once(g3.publish, async () => {
            i4(await this.deleteSession(e));
          });
      ...
      const { id: t, params: i4 } = s;
      try {
        this.isValidRequest(w2({ topic: e }, i4)), await this.setPendingSessionRequest({ id: t, topic: e, params: i4 });
        const n3 = jn3(JSON.stringify(s)), a3 = this.client.session.get(e), o2 = await this.getVerifyContext(n3, a3.peer.metadata);
        this.client.events.emit("session_request", { id: t, topic: e, params: i4, verifyContext: o2 });
      } catch (n3) {
        await this.sendError(t, e, n3), this.client.logger.error(n3);
      }
    }, this.onSessionRequestResponse = (e, s) => {
      const { id: t } = s;
      isJsonRpcResult(s) ? this.events.emit(it6("session_request", t), { result: s.result }) : isJsonRpcError(s) && this.events.emit(it6("session_request", t), { error: s.error });
    }, this.onSessionEventRequest = async (e, s) => {
      const { id: t, params: i4 } = s;
      try {
        this.isValidEmit(w2({ topic: e }, i4)), this.client.events.emit("session_event", { id: t, topic: e, params: i4 });
      } catch (n3) {
        await this.sendError(t, e, n3), this.client.logger.error(n3);
      }
    }, this.isValidConnect = async (e) => {
      if (!$t5(e)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `connect() params: ${JSON.stringify(e)}`);
        throw new Error(o2);
      }
      const { pairingTopic: s, requiredNamespaces: t, optionalNamespaces: i4, sessionProperties: n3, relays: a3 } = e;
      if (S6(s) || await this.isValidPairingTopic(s), !jt2(a3, true)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `connect() relays: ${a3}`);
        throw new Error(o2);
      }
      !S6(t) && x3(t) !== 0 && this.validateNamespaces(t, "requiredNamespaces"), !S6(i4) && x3(i4) !== 0 && this.validateNamespaces(i4, "optionalNamespaces"), S6(n3) || this.validateSessionProps(n3, "sessionProperties");
    }, this.validateNamespaces = (e, s) => {
      const t = wt4(e, "connect()", s);
      if (t)
        throw new Error(t.message);
    }, this.isValidApprove = async (e) => {
      if (!$t5(e))
        throw new Error(N7("MISSING_OR_INVALID", `approve() params: ${e}`).message);
      const { id: s, namespaces: t, relayProtocol: i4, sessionProperties: n3 } = e;
      await this.isValidProposalId(s);
      const a3 = this.client.proposal.get(s), o2 = sn(t, "approve()");
      if (o2)
        throw new Error(o2.message);
      const l2 = an(a3.requiredNamespaces, t, "approve()");
      if (l2)
        throw new Error(l2.message);
      if (!m5(i4, true)) {
        const { message: h3 } = N7("MISSING_OR_INVALID", `approve() relayProtocol: ${i4}`);
        throw new Error(h3);
      }
      S6(n3) || this.validateSessionProps(n3, "sessionProperties");
    }, this.isValidReject = async (e) => {
      if (!$t5(e)) {
        const { message: i4 } = N7("MISSING_OR_INVALID", `reject() params: ${e}`);
        throw new Error(i4);
      }
      const { id: s, reason: t } = e;
      if (await this.isValidProposalId(s), !Dt4(t)) {
        const { message: i4 } = N7("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(t)}`);
        throw new Error(i4);
      }
    }, this.isValidSessionSettleRequest = (e) => {
      if (!$t5(e)) {
        const { message: l2 } = N7("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${e}`);
        throw new Error(l2);
      }
      const { relay: s, controller: t, namespaces: i4, expiry: n3 } = e;
      if (!cn(s)) {
        const { message: l2 } = N7("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
        throw new Error(l2);
      }
      const a3 = _t4(t, "onSessionSettleRequest()");
      if (a3)
        throw new Error(a3.message);
      const o2 = sn(i4, "onSessionSettleRequest()");
      if (o2)
        throw new Error(o2.message);
      if (st6(n3)) {
        const { message: l2 } = N7("EXPIRED", "onSessionSettleRequest()");
        throw new Error(l2);
      }
    }, this.isValidUpdate = async (e) => {
      if (!$t5(e)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `update() params: ${e}`);
        throw new Error(o2);
      }
      const { topic: s, namespaces: t } = e;
      await this.isValidSessionTopic(s);
      const i4 = this.client.session.get(s), n3 = sn(t, "update()");
      if (n3)
        throw new Error(n3.message);
      const a3 = an(i4.requiredNamespaces, t, "update()");
      if (a3)
        throw new Error(a3.message);
    }, this.isValidExtend = async (e) => {
      if (!$t5(e)) {
        const { message: t } = N7("MISSING_OR_INVALID", `extend() params: ${e}`);
        throw new Error(t);
      }
      const { topic: s } = e;
      await this.isValidSessionTopic(s);
      ...
      if (!$t5(e)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `request() params: ${e}`);
        throw new Error(o2);
      }
      const { topic: s, request: t, chainId: i4, expiry: n3 } = e;
      await this.isValidSessionTopic(s);
      const { namespaces: a3 } = this.client.session.get(s);
      if (!kt3(a3, i4)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `request() chainId: ${i4}`);
        throw new Error(o2);
      }
      if (!Vt2(t)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `request() ${JSON.stringify(t)}`);
        throw new Error(o2);
      }
      if (!Lt4(a3, i4, t.method)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `request() method: ${t.method}`);
        throw new Error(o2);
      }
      if (n3 && !qt3(n3, G6)) {
        const { message: o2 } = N7("MISSING_OR_INVALID", `request() expiry: ${n3}. Expiry must be a number (in seconds) between ${G6.min} and ${G6.max}`);
        throw new Error(o2);
      }
    }, this.isValidRespond = async (e) => {
      if (!$t5(e)) {
        const { message: i4 } = N7("MISSING_OR_INVALID", `respond() params: ${e}`);
        throw new Error(i4);
      }
      const { topic: s, response: t } = e;
      if (await this.isValidSessionTopic(s), !Mt4(t)) {
        const { message: i4 } = N7("MISSING_OR_INVALID", `respond() response: ${JSON.stringify(t)}`);
        throw new Error(i4);
      }
    }, this.isValidPing = async (e) => {
      if (!$t5(e)) {
        const { message: t } = N7("MISSING_OR_INVALID", `ping() params: ${e}`);
        throw new Error(t);
      }
      const { topic: s } = e;
      ...
      if (!$t5(e)) {
        const { message: a3 } = N7("MISSING_OR_INVALID", `emit() params: ${e}`);
        throw new Error(a3);
      }
      const { topic: s, event: t, chainId: i4 } = e;
      await this.isValidSessionTopic(s);
      ...
      if (!kt3(n3, i4)) {
        const { message: a3 } = N7("MISSING_OR_INVALID", `emit() chainId: ${i4}`);
        throw new Error(a3);
      }
      if (!Kt4(t)) {
        const { message: a3 } = N7("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(t)}`);
        throw new Error(a3);
      }
      if (!xt4(n3, i4, t.name)) {
        const { message: a3 } = N7("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(t)}`);
      ...
      if (!$t5(e)) {
        const { message: t } = N7("MISSING_OR_INVALID", `disconnect() params: ${e}`);
        throw new Error(t);
      }
      const { topic: s } = e;
      await this.isValidSessionOrPairingTopic(s);
      ...
      try {
        const i4 = await this.client.core.verify.resolve({ attestationId: e, verifyUrl: s.verifyUrl });
        i4 && (t.verified.origin = i4, t.verified.validation = i4 === s.url ? "VALID" : "INVALID");
      } catch (i4) {
      ...
      Object.values(e).forEach((t) => {
        if (!m5(t, false)) {
          const { message: i4 } = N7("MISSING_OR_INVALID", `${s} must be in Record<string, string> format. Received: ${JSON.stringify(t)}`);
          throw new Error(i4);
        }
      });
    };
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: r } = N7("NOT_INITIALIZED", this.name);
      throw new Error(r);
    }
  }
  registerRelayerEvents() {
    this.client.core.relayer.on(g3.message, async (r) => {
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(w.expired, async (r) => {
      const { topic: e, id: s } = rt6(r.target);
      if (s && this.client.pendingRequest.keys.includes(s))
        return await this.deletePendingSessionRequest(s, N7("EXPIRED"), true);
  ...
  isValidPairingTopic(r) {
    if (!m5(r, false)) {
      const { message: e } = N7("MISSING_OR_INVALID", `pairing topic should be a string: ${r}`);
      throw new Error(e);
    }
    if (!this.client.core.pairing.pairings.keys.includes(r)) {
      const { message: e } = N7("NO_MATCHING_KEY", `pairing topic doesn't exist: ${r}`);
      throw new Error(e);
    }
    if (st6(this.client.core.pairing.pairings.get(r).expiry)) {
      const { message: e } = N7("EXPIRED", `pairing topic: ${r}`);
      throw new Error(e);
    }
  }
  async isValidSessionTopic(r) {
    if (!m5(r, false)) {
      const { message: e } = N7("MISSING_OR_INVALID", `session topic should be a string: ${r}`);
      throw new Error(e);
    }
    if (!this.client.session.keys.includes(r)) {
      const { message: e } = N7("NO_MATCHING_KEY", `session topic doesn't exist: ${r}`);
      throw new Error(e);
    }
    if (st6(this.client.session.get(r).expiry)) {
      await this.deleteSession(r);
      const { message: e } = N7("EXPIRED", `session topic: ${r}`);
      throw new Error(e);
    }
  }
  async isValidSessionOrPairingTopic(r) {
    if (this.client.session.keys.includes(r))
      ...
      const { message: e } = N7("NO_MATCHING_KEY", `session or pairing topic doesn't exist: ${r}`);
      throw new Error(e);
    } else {
      const { message: e } = N7("MISSING_OR_INVALID", `session or pairing topic should be a string: ${r}`);
      throw new Error(e);
    }
  }
  async isValidProposalId(r) {
    if (!Ct5(r)) {
      const { message: e } = N7("MISSING_OR_INVALID", `proposal id should be a number: ${r}`);
      throw new Error(e);
    }
    if (!this.client.proposal.keys.includes(r)) {
      const { message: e } = N7("NO_MATCHING_KEY", `proposal id doesn't exist: ${r}`);
      throw new Error(e);
    }
    if (st6(this.client.proposal.get(r).expiry)) {
      await this.deleteProposal(r);
      const { message: e } = N7("EXPIRED", `proposal id: ${r}`);
      throw new Error(e);
    }
  }
};
var ts3 = class extends At4 {
  constructor(r, e) {
    super(r, e, ee4, L3), this.core = r, this.logger = e;
  }
};
var is3 = class extends At4 {
  constructor(r, e) {
    super(r, e, te2, L3), this.core = r, this.logger = e;
  }
};
var rs3 = class extends At4 {
  constructor(r, e) {
    super(r, e, re4, L3, (s) => s.id), this.core = r, this.logger = e;
  }
};
var $8 = class extends b {
  constructor(r) {
    super(r), this.protocol = j4, this.version = k4, this.name = b3.name, this.events = new import_events11.EventEmitter(), this.on = (s, t) => this.events.on(s, t), this.once = (s, t) => this.events.once(s, t), this.off = (s, t) => this.events.off(s, t), this.removeListener = (s, t) => this.events.removeListener(s, t), this.removeAllListeners = (s) => this.events.removeAllListeners(s), this.connect = async (s) => {
      try {
    ...
    const e = typeof (r == null ? void 0 : r.logger) < "u" && typeof (r == null ? void 0 : r.logger) != "string" ? r.logger : (0, import_logger4.pino)((0, import_logger4.getDefaultLoggerOptions)({ level: (r == null ? void 0 : r.logger) || b3.logger }));
    this.core = (r == null ? void 0 : r.core) || new _r(r), this.logger = (0, import_logger4.generateChildLogger)(e, this.name), this.session = new is3(this.core, this.logger), this.proposal = new ts3(this.core, this.logger), this.pendingRequest = new rs3(this.core, this.logger), this.engine = new ss3(this);
  }
  static async init(r) {
    const e = new $8(r);
    return await e.initialize(), e;
...
var m6 = u4 && typeof u4.apply == "function" ? u4.apply : function(t, e, n3) {
  return Function.prototype.apply.call(t, e, n3);
};
var f7;
u4 && typeof u4.ownKeys == "function" ? f7 = u4.ownKeys : Object.getOwnPropertySymbols ? f7 = function(t) {
...
o.prototype.getMaxListeners = function() {
  ...
  for (var e = [], n3 = 1; n3 < arguments.length; n3++)
    e.push(arguments[n3]);
  var i4 = t === "error", a3 = this._events;
  if (a3 !== void 0)
    i4 = i4 && a3.error === void 0;
  else if (!i4)
    return false;
  if (i4) {
    var r;
  ...
  if (typeof c4 == "function")
    ...
    for (var v = c4.length, A3 = b4(c4, v), n3 = 0; n3 < v; ++n3)
      m6(A3[n3], this, e);
  return true;
};
function _4(s, t, e, n3) {
  var i4, a3, r;
  if (g4(e), a3 = s._events, a3 === void 0 ? (a3 = s._events = /* @__PURE__ */ Object.create(null), s._eventsCount = 0) : (a3.newListener !== void 0 && (s.emit("newListener", t, e.listener ? e.listener : e), a3 = s._events), r = a3[t]), r === void 0)
  ...
  else if (typeof r == "function" ? r = a3[t] = n3 ? [e, r] : [r, e] : n3 ? r.unshift(e) : r.push(e), i4 = L4(s), i4 > 0 && r.length > i4 && !r.warned) {
    r.warned = true;
    ...
    h3.name = "MaxListenersExceededWarning", h3.emitter = s, h3.type = t, h3.count = r.length, T3(h3);
  }
  return s;
}
o.prototype.addListener = function(t, e) {
  return _4(this, t, e, false);
}, o.prototype.on = o.prototype.addListener, o.prototype.prependListener = function(t, e) {
  return _4(this, t, e, true);
};
function j5() {
  if (!this.fired)
...
function S7(s, t, e) {
  var n3 = { fired: false, wrapFn: void 0, target: s, type: t, listener: e }, i4 = j5.bind(n3);
  return i4.listener = e, n3.wrapFn = i4, i4;
}
o.prototype.once = function(t, e) {
  return g4(e), this.on(t, S7(this, t, e)), this;
}, o.prototype.prependOnceListener = function(t, e) {
  return g4(e), this.prependListener(t, S7(this, t, e)), this;
}, o.prototype.removeListener = function(t, e) {
  var n3, i4, a3, r, h3;
  if (g4(e), i4 = this._events, i4 === void 0)
    return this;
  if (n3 = i4[t], n3 === void 0)
    return this;
  if (n3 === e || n3.listener === e)
    --this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : (delete i4[t], i4.removeListener && this.emit("removeListener", t, n3.listener || e));
    ...
    if (a3 < 0)
      return this;
    a3 === 0 ? n3.shift() : I2(n3, a3), n3.length === 1 && (i4[t] = n3[0]), i4.removeListener !== void 0 && this.emit("removeListener", t, h3 || e);
  }
  return this;
  ...
  if (arguments.length === 0) {
    ...
    for (i4 = 0; i4 < a3.length; ++i4)
      r = a3[i4], r !== "removeListener" && this.removeAllListeners(r);
...
function C6(s, t, e) {
  ...
  if (n3 === void 0)
    return [];
  var i4 = n3[t];
  return i4 === void 0 ? [] : typeof i4 == "function" ? e ? [i4.listener || i4] : [i4] : e ? W6(i4) : b4(i4, i4.length);
}
...
o.prototype.eventNames = function() {
  return this._eventsCount > 0 ? f7(this._events) : [];
};
function b4(s, t) {
...
function M4(s, t) {
  return new Promise(function(e, n3) {
    ...
    function a3() {
      typeof s.removeListener == "function" && s.removeListener("error", i4), e([].slice.call(arguments));
    }
    R5(s, t, a3, { once: true }), t !== "error" && z4(s, i4, { once: true });
  });
}
function z4(s, t, e) {
  typeof s.on == "function" && R5(s, "error", t, e);
}
function R5(s, t, e, n3) {
  if (typeof s.on == "function")
    n3.once ? s.once(t, e) : s.on(t, e);
  else if (typeof s.addEventListener == "function")
    s.addEventListener(t, function i4(a3) {
      n3.once && s.removeEventListener(t, i4), e(a3);
    });
  else
...
var d4 = "Web3Wallet";
var K3 = `${O3}@${2}:${d4}:`;
var X7 = class extends l.exports {
  constructor() {
    super();
  }
};
...
var $9 = class extends P3 {
  constructor(t) {
    super(t), this.init = async () => {
      this.signClient = await ns3.init({ core: this.client.core, metadata: this.client.metadata }), this.authClient = await Nr.init({ core: this.client.core, projectId: "", metadata: this.client.metadata }), this.initializeEventListeners();
    }, this.pair = async (e) => {
      await this.client.core.pairing.pair(e);
    }, this.approveSession = async (e) => {
      const { topic: n3, acknowledged: i4 } = await this.signClient.approve({ id: e.id, namespaces: e.namespaces });
      return await i4(), this.signClient.session.get(n3);
...
var p5 = class extends x4 {
  constructor(t) {
    ...
    }, this.metadata = t.metadata, this.name = t.name || d4, this.core = t.core, this.logger = this.core.logger, this.engine = new $9(this);
  }
  static async init(t) {
    const e = new p5(t);
    return await e.initialize(), e;
...
var windowGetters = __toESM(require_cjs8());
...
var __spreadArrays = function() {
  ...
  for (var r = Array(s), k5 = 0, i4 = 0; i4 < il; i4++)
    for (var a3 = arguments[i4], j6 = 0, jl = a3.length; j6 < jl; j6++, k5++)
      r[k5] = a3[j6];
  return r;
};
...
init_shim();
var queryStringUtils = __toESM(require_query_string5());
...
var WalletConnectV2Handler = class extends WalletConnectHandler {
  ...
  async init() {
    _classPrivateFieldSet(this, _wcWallet$1, await D2.init({
...
var SmartWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-TIMFVTPU.js");
...
var PaperWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-ZD3ULH55.js");
...
var CoinbaseWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-3GX5FK4U.js");
...
var LocalWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-OKY4WLFL.js");
...
async function defaultEncrypt(message, password) {
  const cryptoJS = (await import("./crypto-js-JPSXV7MW.js")).default;
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-3A3276RP.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect-v1.browser.esm-CUESYRDH.js");
...
var WalletConnect2 = class extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-LYUERXZ2.js");
...
var SafeWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-YHMGU754.js");
...
var MagicLink = class extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-JH4SXMQ4.js");
...
var InjectedWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-MX7PP6D5.js");
...
//# sourceMappingURL=chunk-BJ2JJ7CD.js.map
