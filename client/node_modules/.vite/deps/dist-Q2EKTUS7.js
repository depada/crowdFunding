...
var Pt = class extends LitElement {
  ...
  render() {
    ...
    return html`<div class="w3m-toolbar-placeholder"></div><div class="w3m-toolbar">${this.logoTemplate()}<div class="${classMap(t)}"><button @click="${this.onHelp}">${d2.HELP_ICON}</button> <button @click="${se.close}">${d2.CROSS_ICON}</button></div></div>`;
  }
};
...
var Y = class extends LitElement {
  ...
  backBtnTemplate() {
    return html`<button class="w3m-back-btn" @click="${b.goBack}">${d2.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
...
_e = ya([customElement("w3m-theme-context")], _e);
...
le.styles = [w.globalCss, _a], le = Da([customElement("w3m-android-wallet-selection")], le);
...
var de = class extends LitElement {
  ...
  render() {
    ...
    j ? $ = f.slice(0, 7) : $ = f;
    const _2 = !!$.length;
    return html`<w3m-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${d2.QRCODE_ICON}"></w3m-modal-header>${_2 ? html`<w3m-modal-content><div>${$} ${j ? html`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>` : null}</div></w3m-modal-content>` : null}`;
  }
};
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=dist-Q2EKTUS7.js.map
