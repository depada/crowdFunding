...
// node_modules/@thirdweb-dev/react-core/dist/useTransactions-47099afb.browser.esm.js
init_shim();
...
var ThirdwebAuthProvider = (_ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(ThirdwebAuthContext.Provider, {
    value: authContext,
    children
  });
};
...
async function doLogin(wallet, options) {
  ...
  const payloadData = {
    ...
    expiration_time: new Date((options == null ? void 0 : options.expirationTime) || Date.now() + 1e3 * 60 * 5).toISOString(),
    invalid_before: new Date((options == null ? void 0 : options.invalidBefore) || Date.now()).toISOString(),
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-GELTR3I4.js.map
